...
MODULE model_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'IEB4CHO        ','CH3O2NO2       ','PACLOOA        ', &
     'PPACLOOA       ','CO2C3CO2H      ','PPGAOOB        ', &
     'PGAOOB         ','ISOPBOH        ','C58OH          ', &
     'MMALNHY2OH     ','C57OH          ','N2O5           ', &
     'HO3C5O         ','ISOPAO         ','DIEKBO         ', &
     'HEPTO          ','MMALANHYO      ','HOC4H8OH       ', &
     'PROPACID       ','IEPOXA         ','INAOH          ', &
     'HO13C5         ','C23O3CCO2H     ','INCOH          ', &
     'HCOOH          ','HIEPOXB        ','M3FOOA         ', &
     'HO13C4OH       ','BUTACID        ','INDOH          ', &
     'C524OH         ','NC524OH        ','OCCOHCOH       ', &
     'HOC3H6CO2H     ','HOC2H4CO2H     ','ETHGLY         ', &
     'HEPTOH         ','HOC3H6OH       ','HO134C5        ', &
     'HO2C3CO2H      ','C2OHOCO2H      ','CH3OH          ', &
     'MMALANHY       ','CO2C3OOB       ','H2             ', &
     'INB2O          ','HOCH2COCO2H    ','NC7H16         ', &
     'HO25C7         ','HONO           ','IEPOXC         ', &
     'A2PANO         ','MACO2H         ','HOCO3C54O      ', &
     'C71O           ','MGLYOOB        ','MVKO           ', &
     'TISOPA         ','TISOPC         ','CH2OOG         ', &
     'CH2OOE         ','HMGLYOOA       ','NC4OOA         ', &
     'NOAOOA         ','C531O          ','H1CO23CHO      ', &
     'IPROPOL        ','HMVKBO         ','MEKCO          ', &
     'HO1CO3C4O      ','NPXYFUO        ','NC41OOA        ', &
     'C525O          ','C73O           ','CL             ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_1 = (/ &
     'CH4            ','C531CO         ','C72OH          ', &
     'CO25C74O       ','MCOCOMOXO      ','MVKOHBO        ', &
     'CISOPA         ','CISOPC         ','NC3OOA         ', &
     'CH3CO2H        ','CO25C73O       ','NC2OOA         ', &
     'CH2CHCH2OOH    ','INAHPCO3H      ','C536O          ', &
     'HCOCH2CO2H     ','NC526OOH       ','NC51OOH        ', &
     'INB1NBCO2H     ','PERPROACID     ','HO3C76OOH      ', &
     'CH3CO3H        ','INAHCO2H       ','CO2N3PAN       ', &
     'C533OOH        ','HO13C5OOH      ','IECCO3H        ', &
     'NC524NO3       ','ISOP34OOH      ','ALLYLOH        ', &
     'OCCOHCOOH      ','MVKOHANO3      ','MVKOHAOOH      ', &
     'C58NO3CO2H     ','INB1NACO2H     ','MMALNHYOOH     ', &
     'C2OHOCOOH      ','INB1HPCO3H     ','C510OOH        ', &
     'HO2C3CO3H      ','IPRHOCO2H      ','C72OOH         ', &
     'C45OOH         ','INAHPCO2H      ','HO2C4OH        ', &
     'HC4CCO2H       ','HOCHOCOOH      ','HCOCH2CO3H     ', &
     'INCNCO2H       ','CO3C4CO2H      ','NBUTOLANO3     ', &
     'PXYFUOOH       ','HOC3H6CO3H     ','NISOPOOH       ', &
     'C51OOH         ','IEACO3H        ','HMACO2H        ', &
     'C3DIOLOOH      ','CO2C3CO3H      ','ISOPDOH        ', &
     'NBUTOLAOH      ','M3BU3ECO3H     ','C57NO3CO2H     ', &
     'HMVKAOOH       ','PERBUACID      ','HO3C4NO3       ', &
     'HEPTOOH        ','HOC2H4CO3H     ','C537O          ', &
     'C530OOH        ','CO23C4CO3H     ','CO3C4CO3H      ', &
     'INDHPCO3H      ','HO13C4NO3      ','C23O3CCO3H     ', &
     'CO3C75OOH      ','PRNO3CO2H      ','INANCO2H       ', &
     'HO3C4CO3H      ','HO2NO2         ','HVMK           ', &
     'C59O           ','IBUTALOH       ','INB1HPCHO      ', &
     'PXYFUO         ','NBUTOL         ','CO25C74OH      ', &
     'C4M2AL2OH      ','CH3O           ','HMVKNGLYOX     ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_2 = (/ &
     'CO25C73OH      ','INAHCHO        ','HO14CO2C4      ', &
     'IC3H7O         ','HO1C4O         ','HO14CO3C5      ', &
     'NC3H7O         ','INB1NACHO      ','NPROPOL        ', &
     'INDHPCHO       ','INAHPCHO       ','GLYOOB         ', &
     'C2H5OH         ','HO1C3O         ','C3MDIALO       ', &
     'IC3H7NO3       ','ACO2H          ','CH3CHOOA       ', &
     'NBUTOLAO       ','HO13C4O        ','HO3C76NO3      ', &
     'HO3C76O        ','HMML           ','C2H5O          ', &
     'C535O          ','HEPTNO3        ','ETHO2HNO3      ', &
     'IPROPOLPER     ','HO1C4NO3       ','INCO           ', &
     'HO1C3NO3       ','MEKAOOH        ','IPROPOLO2H     ', &
     'INB1GLYOX      ','C71OOH         ','HOCH2CO2H      ', &
     'IPRHOCO3H      ','INB1NBCHO      ','CH2CHCH2O      ', &
     'DIEKBOOH       ','CH3OOH         ','C73OOH         ', &
     'HPC52CO3H      ','PROPGLY        ','NISOPNO3       ', &
     'NISOPO         ','C525OOH        ','NC4H9OOH       ', &
     'H13CO2CO3H     ','C524CO         ','MACRO          ', &
     'C534OOH        ','INDHCO3H       ','C51NO3         ', &
     'INCGLYOX       ','HO3C5NO3       ','HIEB1O         ', &
     'HO13C5NO3      ','INB1HPPAN      ','C58OOH         ', &
     'NBUTOLBOOH     ','HO13C3CO3H     ','HO1C3OOH       ', &
     'BUTALNO3       ','HPNC524CO      ','HO2C4OOH       ', &
     'GAOOB          ','CH3NO3         ','DIEKBNO3       ', &
     'HYPROPO        ','INB1NBCO3H     ','HO3C4O         ', &
     'HYETHO2H       ','ETHOHNO3       ','C524NO3        ', &
     'CO2N3CO3H      ','C57OOH         ','H14CO23C4      ', &
     'IC3H7OOH       ','NBUTOLBNO3     ','HOCO3C5OOH     ', &
     'BIACETO        ','INAO           ','NC4H9NO3       ', &
     'NO3CH2CO2H     ','HO3C3CO3H      ','INAHPPAN       ', &
     'NC3H7NO3       ','HC4ACO2H       ','C45NO3         ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_3 = (/ &
     'C45O           ','NPXYFUOOH      ','HO3C5OOH       ', &
     'INB1NACO3H     ','C58AOOH        ','NC3H7OOH       ', &
     'MCOCOMOOOH     ','MACRNBPAN      ','C526O          ', &
     'HC4CO3H        ','NO3CH2CO3H     ','CISOPAO        ', &
     'HO1C4OOH       ','HOCH2CO3H      ','PR2O2HNO3      ', &
     'C2H5NO3        ','INAHCO3H       ','HCOCOHCO3H     ', &
     'CH3COCH2O      ','PRNO3CO3H      ','ACLOOA         ', &
     'INANCHO        ','INB1O          ','HIEB2O         ', &
     'PR1O2HNO3      ','MEKANO3        ','C72NO3         ', &
     'CO2C3OOA       ','CH2OOA         ','INCNCO3H       ', &
     'MACROHO        ','PROLNO3        ','C527O          ', &
     'OCCOHCO        ','INANCO3H       ','CO25C73OOH     ', &
     'CH2CHCH2NO3    ','C74O           ','C2H5OOH        ', &
     'HO2C4NO3       ','HMGLOOA        ','C57AO          ', &
     'CO245C7        ','C47CHO         ','HPC52O         ', &
     'INB1OH         ','ISOPBOOH       ','CHOMOHCO3H     ', &
     'NC4CO2H        ','MGLOOA         ','MACRNOOA       ', &
     'MACROOA        ','HNC524CO       ','C4M2ALOHNO3    ', &
     'PHAN           ','IEAPAN         ','C72O           ', &
     'MEKAO          ','INANCOPAN      ','ISOPDOOH       ', &
     'CHOCOHCO       ','C23O3CPAN      ','DNC524CO       ', &
     'IPROPOLO       ','IECPAN         ','C3PAN2         ', &
     'C3PAN1         ','C4PAN6         ','HC4PAN         ', &
     'C74OOH         ','INANCOCO2H     ','C5PAN8         ', &
     'HMAC           ','C4PAN2         ','HO1CO3C5       ', &
     'C534O          ','INANCOCO3H     ','IPROPOLPAN     ', &
     'PAN            ','HMACROH        ','ISOP34O        ', &
     'NC51O          ','C510O          ','C5PAN18        ', &
     'C5PAN16        ','HO3C3PAN       ','HCOCH2O        ', &
     'CO2C3PAN       ','HO2C4O         ','A2PAN          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_4 = (/ &
     ...
     'MACRNBCO3H     ','ISOPDO         ','HYPROPO2H      ', &
     'C5PAN19        ','C527OOH        ','C5PAN17        ', &
     'HMACO3H        ','HO3C4OOH       ','C31PAN         ', &
     'HO13C4OOH      ','CO24C4CHO      ','ACO3H          ', &
     'MC3CODBPAN     ','C47PAN         ','HMACRO         ', &
     'HMACROOH       ','HIEB2OOH       ','C526NO3        ', &
     'INAHPAN        ','NBUTOLAOOH     ','C59OOH         ', &
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_5 = (/ &
     ...
     'CH3COPAN       ','MACROOH        ','HO3CO6C7       ', &
     'MACRNCO2H      ','BUTALO         ','MMALNBPAN      ', &
     'ETHENO3O       ','HPC52OOH       ','IECCHO         ', &
     'DHPMEK         ','CHOOCHO        ','CH3COCO2H      ', &
     'IEACHO         ','C58ANO3        ','C526OOH        ', &
     'MACO3H         ','CONM2CO3H      ','HO2CO35C7      ', &
     'MMALNBCO2H     ','MMALNACO2H     ','CO2H3CO3H      ', &
     'CISOPCO        ','COHM2CO3H      ','INDHCHO        ', &
     'NC524O         ','GLYOOC         ','HMVKBOOH       ', &
     'MACROHOOH      ','INDOOH         ','BUTALO2H       ', &
     'INAOOH         ','MMALNBCO3H     ','C532CO         ', &
     'CH2CHCH2O2     ','VGLYOX         ','CONM2PAN       ', &
     'MMALNAPAN      ','C537OOH        ','C23O3CHO       ', &
     'IEC2OOH        ','HO13CO4C5      ','MMALNACO3H     ', &
     'HO1CO3CHO      ','HMVKNO3        ','PRONO3BO       ', &
     'NC526O         ','PRONO3AO       ','MVKOHAOH       ', &
     'O              ','NC524OOH       ','INB1OOH        ', &
     'C524OOH        ','C535OOH        ','CH2OOB         ', &
     'CH3C2H2O2      ','NISOPO2        ','PXYFUONE       ', &
     'INCCO          ','INB1CO         ','MC3CODBCO2     ', &
     'C536OOH        ','BIACETOOH      ','HO2CO5C7       ', &
     'C4MALOHOOH     ','HO1C4O2        ','CO3C75O2       ', &
     'MEKCOH         ','C3MDIALOOH     ','INDO           ', &
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_6 = (/ &
     ...
     'C73O2          ','HMGLYOO        ','C2H5O2         ', &
     'INDHCO3        ','M3BU3ECO3      ','NOAOO          ', &
     'IECCO3         ','CHOMOHCO3      ','CO2N3CO3       ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_43 = (/ &
     ...
     '         C526OOH --> HOCH2CHO + MGLYOX + 2 OH                                                       ', &
     '    C526NO3 + OH --> HMVKBOOH + CO + NO2                                                            ', &
     '         C526NO3 --> C526O + NO2                                                                    ', &
     '           C526O --> HOCH2CHO + MGLYOX + OH                                                         ', &
     '      NC2OO + CO --> NO3CH2CHO                                                                      ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_47 = (/ &
     ...
     '         C57AOOH --> C57AO + OH                                                                     ', &
     '           C57AO --> HOCH2CHO + MGLYOX + HO2                                                        ', &
     '    INDHCHO + OH --> INDHCO3                                                                        ', &
     '         INDHCHO --> HOCH2CHO + MGLYOX + HO2 + NO2                                                  ', &
     '          C57OOH --> C57O + OH                                                                      ', &
     '     C57OOH + OH --> HO12CO3C4 + CO + OH                                                            ', &
     '     C57NO3 + OH --> C4M2ALOHNO3 + HO2                                                              ', &
     '     C57NO3 + OH --> C57NO3CO3                                                                      ', &
     '          C57NO3 --> HOCH2CHO + MGLYOX + HO2 + NO2                                                  ', &
     '            C57O --> HOCH2CHO + MGLYOX + HO2                                                        ', &
     '      C57OH + OH --> C57O                                                                           ', &
     '      NC4OO + CO --> MVKNO3                                                                         ', &
     '      NC4OO + NO --> MVKNO3 + NO2                                                                   ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_59 = (/ &
     ...
     '        INDHPCHO --> HOCH2CHO + MGLYOX + NO2 + OH                                                   ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(2508) :: EQN_NAMES = (/&
    ...
    EQN_NAMES_80, EQN_NAMES_81, EQN_NAMES_82, EQN_NAMES_83 /)
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(2508) :: EQN_TAGS = (/&
    ...
    EQN_TAGS_25, EQN_TAGS_26, EQN_TAGS_27 /)
