...
def spectral_embedding(adjacency, n_components=8, eigen_solver=None,
    ...
    * Toward the Optimal Preconditioned Eigensolver: Locally Optimal
    ...
    if not _graph_is_connected(adjacency):
        warnings.warn("HEEEEYY Graph is not fully connected, spectral embedding"
    ...
    print (np.argmax(np.diff(lambdas)),lambdas,embedding.shape)
    
    n_components = np.argmax(np.diff(lambdas)+1)
