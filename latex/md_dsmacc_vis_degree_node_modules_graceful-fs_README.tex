...
\item fixes {\ttfamily lchmod} for \mbox{\hyperlink{classNode}{Node}} versions prior to 0.\+6.\+2.
...
The current approach loads the {\ttfamily fs} module, and then creates a lookalike object that has all the same methods, except a few that are patched. It is safe to use in all versions of \mbox{\hyperlink{classNode}{Node}} from 0.\+8 through 7.\+0.
