...
\item Streaming support for \mbox{\hyperlink{classNode}{Node}} v0.\+10+
...
\#\#\# Streaming A\+PI (\mbox{\hyperlink{classNode}{Node}} v0.\+10+) 
\begin{DoxyCode}
...
Comparison with node-\/iconv module (1000x256kb, on Mac\+Book Pro, Core i5/2.\+6 G\+Hz, \mbox{\hyperlink{classNode}{Node}} v0.\+12.\+0). Note\+: your results may vary, so please always check on your hardware. \begin{DoxyVerb}operation             iconv@2.1.4   iconv-lite@0.4.7
----------------------------------------------------------
...
\mbox{\hyperlink{classNode}{Node}} versions 0.\+10.\+31 and 0.\+11.\+13 are buggy, don\textquotesingle{}t use them (see \#65, \#77). ~\newline
 \subsection*{Testing}
