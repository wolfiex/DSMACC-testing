...
As developer certificates are required for {\ttfamily codesign} on mac\+OS, this module is difficult to be tested via online build services. If you wish to test out this module, enter\+:
...
When this command is fun for the first time\+: {\ttfamily electron-\/download} will download all major releases of Electron available for mac\+OS from 0.\+24.\+0, and save to {\ttfamily $\sim$/.electron/}, which might take up less than 1\+GB of disk space.
