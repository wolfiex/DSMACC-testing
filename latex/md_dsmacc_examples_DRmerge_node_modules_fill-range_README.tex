...
\rowcolor{\tableheadbgcolor}\multicolumn{2}{|p{(\linewidth-\tabcolsep*2-\arrayrulewidth*1)*2/2}|}{\cellcolor{\tableheadbgcolor}\textbf{ $\ast$$\ast$\+Commits$\ast$   }}\\\cline{1-2}
\endhead
116  &\href{https://github.com/jonschlinkert}{\tt jonschlinkert}   \\\cline{1-2}
4  &\href{https://github.com/paulmillr}{\tt paulmillr}   \\\cline{1-2}
2  &\href{https://github.com/realityking}{\tt realityking}   \\\cline{1-2}
2  &\href{https://github.com/bluelovers}{\tt bluelovers}   \\\cline{1-2}
1  &\href{https://github.com/edorivai}{\tt edorivai}   \\\cline{1-2}
