...
\subsection*{4.\+0.\+2 / 2017-\/09-\/12 }


\begin{DoxyItemize}
\item Added {\ttfamily E\+OL} option to {\ttfamily write\+Json$\ast$} \& {\ttfamily output\+Json$\ast$} (via upgrade to jsonfile v4)
\item Added promise support to \href{https://nodejs.org/api/fs.html#fs_fs_copyfile_src_dest_flags_callback}{\tt {\ttfamily fs.\+copy\+File()}} in \mbox{\hyperlink{classNode}{Node}} 8.\+5+
...
\begin{DoxyItemize}
\item {\bfseries B\+R\+E\+A\+K\+I\+NG\+:} Removed support for \mbox{\hyperlink{classNode}{Node}} {\ttfamily v0.\+12}. The \mbox{\hyperlink{classNode}{Node}} foundation stopped officially supporting it on Jan 1st, 2017.
...
\begin{DoxyItemize}
\item {\bfseries B\+R\+E\+A\+K\+I\+NG}\+: dropped \mbox{\hyperlink{classNode}{Node}} v0.\+10 support.
...
\begin{DoxyItemize}
\item Brought back \mbox{\hyperlink{classNode}{Node}} v0.\+10 support. I didn\textquotesingle{}t realize there was still demand. Official support will end {\bfseries 2016-\/10-\/01}.
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\bfseries B\+R\+E\+A\+K\+I\+NG}\+: removed support for \mbox{\hyperlink{classNode}{Node}} v0.\+10. If you still want to use \mbox{\hyperlink{classNode}{Node}} v0.\+10, everything should work except for {\ttfamily ensure\+Link()/ensure\+Symlink()}. \mbox{\hyperlink{classNode}{Node}} v0.\+12 is still supported but will be dropped in the near future as well.
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\ttfamily fs.\+copy()} had support for \mbox{\hyperlink{classNode}{Node}} v0.\+8, dropped support
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item fixed {\ttfamily fs.\+copy} for \mbox{\hyperlink{classNode}{Node}} v0.\+8 (support is temporary and will be removed in the near future)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item changed J\+S\+ON spacing default from {\ttfamily 4} to {\ttfamily 2} to follow \mbox{\hyperlink{classNode}{Node}} conventions
...
\item Verified \mbox{\hyperlink{classNode}{Node}} v0.\+8 compatibility.
\end{DoxyItemize}
