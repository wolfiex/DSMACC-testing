...
* Input/output variables
      ...
      CHARACTER(lcl) slabel(ks), jlabel(kj)
...
* choose input file
 ...
 120  FORMAT(a6)
      ...
      IF(inpfil .EQ. '1') inpfil = 'defin1'
      IF(inpfil .EQ. '2') inpfil = 'defin2'
      IF(inpfil .EQ. '3') inpfil = 'defin3'
      IF(inpfil .EQ. '4') inpfil = 'defin4'
...
* confirm or change or get help
 ...
 30   CONTINUE
      ...
      WRITE(*,*) '(nmj to toggle output of j values on/off):'
      READ(*,300) avar
 300  FORMAT(A7)
...
** check output file name
      ...
      WRITE(finame,'(3A)') '../',trim(adjustl(outfil)),'.txt'
