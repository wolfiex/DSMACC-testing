...
specs['cc0'] = specs['TBUACET']+specs['NBUTACET']+specs['IPROPOL']+specs['IPRHOCO2H']+specs['ETHGLY'] \
    ...
    +specs['DIIPRETOH']+specs['CH4']+specs['ETBEAOH']+specs['HO2C5OH']+specs['HIEPOXB'] \
    +specs['PRCOFORM']+specs['ALLYLOH']+specs['PROH2MOX']+specs['NC8H18']+specs['PROPGLY'] \
    +specs['H14M4C6']+specs['HOCH2CO2H']+specs['SBUACAOH']+specs['C524OH']+specs['IPROACET'] \
    +specs['HEXBOH']+specs['M2PE']+specs['M3HEXAOH']+specs['CHEX']+specs['MTBEBOH'] \
    +specs['HOC2H4CO2H']+specs['HC4CCO2H']+specs['H2M2C4CO2H']+specs['MO2EOLB2OH']+specs['M2PEAOH'] \
    +specs['ME2BUT2ENE']+specs['C52OH']+specs['DIETETHER']+specs['CL']+specs['M3HEX'] \
    +specs['HC4ACO2H']+specs['PENT1ENE']+specs['NC12H26']+specs['DM23BU2ENE']+specs['BUOX2ETOH'] \
    +specs['C4ME22OH']+specs['MTBE']+specs['IEPOXC']+specs['PROL2FORM']+specs['NBUTOLAOH'] \
    +specs['M2HEXBOH']+specs['PXYFUONE']+specs['HOC3H6CO2H']+specs['DIIPRETHER']+specs['H3M3C5CO2H'] \
    +specs['M3F']+specs['M23C4']+specs['M2BUOL2OH']+specs['ETHACET']+specs['BOXMOH'] \
    +specs['M3PE']+specs['H25M2C6']+specs['HO2M2C4OH']+specs['BOX2PROL']+specs['OCTOH'] \
    +specs['HO3C5CO2H']+specs['M2C43CO2H']+specs['NBUTOL']+specs['HOC4H8OH']+specs['NC5H12'] \
    +specs['M2HEX']+specs['CYHXDIOLA']+specs['HO12C5']+specs['BOXOHETOH']+specs['EOX2COMEOH'] \
    +specs['IPROCHO']+specs['HO14M3C5']+specs['HO124C5']+specs['HO13C5']+specs['NEOP'] \
    +specs['MTBEACHOHO']+specs['CYHEXOL']+specs['ACO2H']+specs['M33C3CO2H']+specs['NPROACET'] \
    +specs['IC4H10']+specs['EOX2EOL']+specs['IPROC21OH']+specs['CHEX2ENE']+specs['HM33C3CO2H'] \
    +specs['HO36C11']+specs['ME3BUT1ENE']+specs['PENTACID']+specs['TBUTOL']+specs['ETBECOH'] \
    +specs['H134M3C5']+specs['NPRACBOH']+specs['PXYFUOH']+specs['HEX1ENE']+specs['NEOPOH'] \
    +specs['TBOCOCH2OH']+specs['CH3OCH2OH']+specs['M33C4OH']+specs['BOXCOEOL']+specs['ETOMECO2H'] \
    +specs['M23C43OH']+specs['NC4H10']+specs['IPEBOH']+specs['C523OH']+specs['M2PECOH'] \
    +specs['NBUACBOH']+specs['CHOOCH2OH']+specs['HO13M2C4']+specs['EOX2ETA2OH']+specs['IBUTACID'] \
    +specs['MTBEBCO2H']+specs['BUTDBOH']+specs['HC3CO2H']+specs['HM22C3CO2H']+specs['HO2C3CO2H'] \
    +specs['IC5H12']+specs['ETOMENO3']+specs['HM23C4OH']+specs['BUT2OLOH']+specs['IPROMC2OH'] \
    +specs['CH3OH']+specs['M22C4OH']+specs['NC10H22']+specs['HOIPRCO2H']+specs['MMALANHY'] \
    +specs['PEAOH']+specs['HM22C3OH']+specs['MEPROPENE']+specs['M3PEAOH']+specs['PECOH'] \
    +specs['METHACET']+specs['VINOH']+specs['MO2EOL']+specs['ETHOX']+specs['MBOAOH'] \
    +specs['PRCOOETOH']+specs['C645OH']+specs['C4ME3HO23']+specs['HO2C4OH']+specs['CH3OCH3'] \
    +specs['H13M3C5']+specs['CH3OCHO']+specs['EIPEOH']+specs['H25M3C6']+specs['HEXCOH'] \
    +specs['IPRACOH']+specs['ETACETOH']+specs['HEXAOH']+specs['C3ME3CO2H']+specs['HCOOH'] \
    +specs['C4ME3HO12']+specs['ME2BUT1ENE']+specs['MTBEACHO']+specs['BUTACID']+specs['NPRACAOH'] \
    +specs['HO2C43CO2H']+specs['HO14MC5']+specs['ME3BUOL']+specs['IPRFORMOH']+specs['SBUACBOH'] \
    +specs['CPENT2ENE']+specs['BOX2E2OH']+specs['SBUTACET']+specs['HMML']+specs['HO24C5'] \
    +specs['HOC3H6OH']+specs['DIETETOH']+specs['C2OHOCO2H']+specs['MTBEAOH']+specs['ISOPDOH'] \
    +specs['HOBUT2CO2H']+specs['BOXPR2OH']+specs['BOXPOLBOOH']+specs['TPENT2ENE']+specs['M2PEBOH'] \
    +specs['HO2M2C5OH']+specs['NC11H24']+specs['TBUACOH']+specs['DDECOH']+specs['MMALNHY2OH'] \
    +specs['HM22CO2H']+specs['ISOPBOH']+specs['HO25C7']+specs['HO25C6']+specs['C4H6'] \
    +specs['MOXCOCH2OH']+specs['BOXMCO2H']+specs['NC7H16']+specs['ISOPAOH']+specs['NPROPOL'] \
    +specs['M22C4']+specs['H2M3C4CO2H']+specs['PROPACID']+specs['METACETHO']+specs['ETBEBOH'] \
    +specs['MTBEALCO2H']+specs['BUT2OL']+specs['NONOH']+specs['ETHFORM']+specs['IBUTOLOHC'] \
    +specs['IBUTOLOHB']+specs['BUOHFORM']+specs['ETBE']+specs['BOXOHPROL']+specs['PRCOOPROL'] \
    +specs['C656OH']+specs['IPRMEETOH']+specs['M22C43OH']+specs['UDECOH']+specs['HO36C9'] \
    +specs['HO36C8']+specs['ETOMEOH']+specs['IBUTOL']+specs['METACETOH']+specs['C6H13CO2H'] \
    +specs['BOXCHO']+specs['METHCOACET']+specs['CHOOMCO2H']+specs['HO2C54CO2H']+specs['NBUACAOH'] \
    +specs['NBUACCOH']+specs['HMACO2H']+specs['ETOHOCHO']+specs['NC6H14']+specs['C5H8'] \
    +specs['HO13C4OH']+specs['MEMOXYCO2H']+specs['C3H5CO2H']+specs['DECOH']+specs['IPRACBCO2H'] \
    +specs['M3PECOH']+specs['C3H6']+specs['C3H8']+specs['NPRACCOH']+specs['C2H6'] \
    +specs['C2H4']+specs['M2HEXAOH']+specs['CBUT2ENE']+specs['H2C3OCOH']+specs['M3HEXBOH'] \
    +specs['C54OH']+specs['HO134C5']+specs['MBO']+specs['TBUT2ENE']+specs['M3PEBOH'] \
    +specs['BUT1ENE']+specs['IPECOH']+specs['IPEAOH']+specs['M2PEDOH']+specs['C2H5OH'] \
    +specs['ACETCOC2H5']+specs['ETHFORMOH']+specs['ETOHCO2M']+specs['CHOOCHO']+specs['HM2C43CO2H'] \
    +specs['CH3CO2H']+specs['HO14C6']+specs['PR2OHMOX']+specs['HO36C12']+specs['HO36C10']
specs['cn1'] = specs['CH4']+specs['CH3NO3']+specs['CH3OH']+specs['CH3O2NO2']+specs['HCOOH'] \
    +specs['HCHO']+specs['CH3OOH']
...
specs['oc1'] = specs['TBUACET']+specs['NBUTACET']+specs['IPROPOL']+specs['HM33C4OH']+specs['NC9H20'] \
    ...
    +specs['DIIPRETOH']+specs['M22C3CHO']+specs['CH4']+specs['ETBEAOH']+specs['HO2C5OH'] \
    +specs['M2HEXBOOH']+specs['PEBOOH']+specs['HO2CO4C5']+specs['C4OHCHO']+specs['C124OH'] \
    +specs['CO23C5']+specs['CO23C6']+specs['CO25C74OH']+specs['ALLYLOH']+specs['C77CO'] \
    +specs['NC8H18']+specs['H14M4C6']+specs['MIPKAOH']+specs['NONNO3']+specs['IPROACET'] \
    +specs['C123CO']+specs['HEXBOH']+specs['M2PE']+specs['CO356C9']+specs['M3HEXAOH'] \
    +specs['HO3CO6C7']+specs['C75OOH']+specs['CHEX']+specs['HO3CO6C8']+specs['MTBEBOH'] \
    +specs['C77OH']+specs['C114OH']+specs['HC4CHO']+specs['C122OOH']+specs['M22C4OOH'] \
    +specs['CO3C85OOH']+specs['M2PEAOH']+specs['OCTOOH']+specs['C123OOH']+specs['ME2BUT2ENE'] \
    +specs['C52OH']+specs['MIBK3CO']+specs['DIETETHER']+specs['M2PEAOOH']+specs['M3HEX'] \
    +specs['PENT1ENE']+specs['M22C43OOH']+specs['NC12H26']+specs['DM23BU2ENE']+specs['IPEBOOH'] \
    +specs['C78OH']+specs['BUOX2ETOH']+specs['C6H13CHO']+specs['ME3CO2BUOL']+specs['C4ME22OH'] \
    +specs['IPRGLYOX']+specs['CO24C6']+specs['CO24C5']+specs['MTBE']+specs['MTBK'] \
    +specs['DDECOOH']+specs['M2HEXBOH']+specs['HEPTOOH']+specs['C84OH']+specs['C4MDIAL'] \
    +specs['PXYFUONE']+specs['C51OH2CO']+specs['DIIPRETHER']+specs['H3M3C5CO2H']+specs['M3F'] \
    +specs['M23C4']+specs['M2BUOL2OH']+specs['BOXMOH']+specs['CO245C7']+specs['M3PE'] \
    +specs['M2HEXANO3']+specs['MTBKOH']+specs['HO6CO9C11']+specs['H2M2C4CHO']+specs['H25M2C6'] \
    +specs['HO2M2C4OH']+specs['BOX2PROL']+specs['OCTOH']+specs['HO3C106NO3']+specs['M2C43CO2H'] \
    +specs['MIBK']+specs['NBUTOL']+specs['CO346C8']+specs['NC5H12']+specs['M2HEX'] \
    +specs['ETBEACHO']+specs['HM22C3CHO']+specs['CYC6DIONE']+specs['C4ALDB']+specs['HO3C126NO3'] \
    +specs['CYHXDIOLA']+specs['HO12C5']+specs['CO25C73OH']+specs['HO14M3C5']+specs['HO3C116OOH'] \
    +specs['C3H7CHO']+specs['HO13C5']+specs['M3C4CHO']+specs['NEOP']+specs['CO3C5CHO'] \
    +specs['HO3C76OOH']+specs['CYHEXOL']+specs['M33C3CO2H']+specs['NPROACET']+specs['HC4ACHO'] \
    +specs['IC4H10']+specs['CO36C8']+specs['IPROC21OH']+specs['C113OOH']+specs['CHEX2ENE'] \
    +specs['H2M4C65OOH']+specs['C103OOH']+specs['HO36C11']+specs['ME3BUT1ENE']+specs['IPRCHO'] \
    +specs['HM2C43CHO']+specs['PENTACID']+specs['M3PEAOOH']+specs['M3PEBOOH']+specs['TBUTOL'] \
    +specs['NEOPOOH']+specs['M3PECOOH']+specs['ETBECOH']+specs['C104OOH']+specs['PECOOH'] \
    +specs['HEX1ENE']+specs['HC4CCHO']+specs['NEOPOH']+specs['HO5CO8C10']+specs['C93OH'] \
    +specs['HO3C96NO3']+specs['H2M2CO5C6']+specs['CYHEXONE']+specs['H2M2C65OOH']+specs['M33C4OH'] \
    +specs['C3ME3CHO']+specs['BOXCOEOL']+specs['HO2C43CHO']+specs['M23C43OH']+specs['NC4H10'] \
    +specs['C710OOH']+specs['IPEBOH']+specs['C523OH']+specs['M2PECOH']+specs['HOBUT2CHO'] \
    +specs['M3HEXANO3']+specs['HO13M2C4']+specs['UDECOOH']+specs['C72OH']+specs['M2PEBOOH'] \
    +specs['IC5H12']+specs['BUT2CHO']+specs['HO4CO7C9']+specs['HM23C4OH']+specs['IPROMC2OH'] \
    +specs['IPECOOH']+specs['C5H11CHO']+specs['HO3CO46C8']+specs['M22C4OH']+specs['MIBKBOH'] \
    +specs['HO3C4CHO']+specs['IPEAOOH']+specs['CO3C75OOH']+specs['NC10H22']+specs['DECOOH'] \
    +specs['C4COMEOH']+specs['M2CO5C6']+specs['M3HEXBOOH']+specs['ME3BU3ECHO']+specs['PEAOH'] \
    +specs['BOXPRONE']+specs['HM22C3OH']+specs['HO2CO35C7']+specs['MEPROPENE']+specs['TBUTCHO'] \
    +specs['IPROMCCHO']+specs['HEPTNO3']+specs['M3PEAOH']+specs['C113OH']+specs['PECOH'] \
    +specs['HO5C5CHO']+specs['OCT3ONE']+specs['HO6C7OOH']+specs['C645OH']+specs['C4ME3HO23'] \
    +specs['M2BKAOH']+specs['MIPK']+specs['M2HEXBNO3']+specs['H2M2C3CHO']+specs['H13M3C5'] \
    +specs['C103OH']+specs['CH3COCH3']+specs['CO235C7']+specs['C6DIAL']+specs['EIPEOH'] \
    +specs['HO3C86OOH']+specs['MIPKBOH']+specs['H25M3C6']+specs['HEXCOH']+specs['DIEKAOH'] \
    +specs['HEXAOH']+specs['M23C4OOH']+specs['C3ME3CO2H']+specs['CO2M3C4CHO']+specs['C4ME3HO12'] \
    +specs['C92OOH']+specs['C714OH']+specs['HEX3ONDOH']+specs['C712OH']+specs['HO8C9CO3H'] \
    +specs['H2M3CO5C6']+specs['ME2BUT1ENE']+specs['BOX2ECHO']+specs['MTBEACHO']+specs['HO7C8CO3H'] \
    +specs['C121OOH']+specs['M2BK']+specs['PROL1MCHO']+specs['C94OOH']+specs['HEX3ONE'] \
    +specs['DDEC3ONE']+specs['CHEXOOH']+specs['UDEC3ONE']+specs['HO14MC5']+specs['ME3BUOL'] \
    +specs['C124OOH']+specs['HO1CO3C5']+specs['C93CO']+specs['C3COCCHO']+specs['CO25C6'] \
    +specs['CO25C7']+specs['DDECNO3']+specs['CPENT2ENE']+specs['EIPKAOH']+specs['NONOOH'] \
    +specs['MIBKAOH']+specs['CO2HO3C6']+specs['C114OOH']+specs['SBUTACET']+specs['C115OOH'] \
    +specs['HO24C5']+specs['MTBEAOH']+specs['ISOPDOH']+specs['MPAN']+specs['BOXPR2OH'] \
    +specs['C3M3OH2CHO']+specs['TPENT2ENE']+specs['C123NO3']+specs['OCTNO3']+specs['M2PEBOH'] \
    +specs['HEXCOOH']+specs['MTBEBCHO']+specs['HO2M2C5OH']+specs['NC11H24']+specs['HO3C106OOH'] \
    +specs['C113CO']+specs['DDECOH']+specs['CYHXONAOH']+specs['HM33C3CHO']+specs['ACR'] \
    +specs['NON3ONE']+specs['M33C4OOH']+specs['HEPT3ONE']+specs['ISOPBOH']+specs['H3M3C4CHO'] \
    +specs['HO25C7']+specs['HO25C6']+specs['MEK']+specs['HO3C116NO3']+specs['CO2C54CHO'] \
    +specs['C4H6']+specs['H2M5C65OOH']+specs['C6H13CO3H']+specs['H2M3C4CHO']+specs['ETBECCHO'] \
    +specs['NC7H16']+specs['C6CO34']+specs['CO3C54CHO']+specs['PEAOOH']+specs['ISOPAOH'] \
    +specs['C4H9CHO']+specs['HEX2ONE']+specs['NPROPOL']+specs['M22C4']+specs['H3M3C5CHO'] \
    +specs['ETBEBOH']+specs['CO2C5OH']+specs['EIPKBOH']+specs['BUT2OL']+specs['HO2C4CHO'] \
    +specs['NONOH']+specs['C54CHO']+specs['M2C43CHO']+specs['MVK']+specs['CO2M33CHO'] \
    +specs['M2HEXAOOH']+specs['M2BKBOH']+specs['C123OH']+specs['C91OOH']+specs['ETBE'] \
    +specs['BOXOHPROL']+specs['PRCOOPROL']+specs['BOXPRONBOH']+specs['C94OH']+specs['H3M3C6OOH'] \
    +specs['C656OH']+specs['HO3C126OOH']+specs['CO36C10']+specs['M22C43OH']+specs['HM22CHO'] \
    +specs['HO8C9OOH']+specs['UDECOH']+specs['HO3C96OOH']+specs['HO36C9']+specs['HO36C8'] \
    +specs['IBUTOL']+specs['C101OOH']+specs['C6H13CO2H']+specs['BOXCHO']+specs['M3CO245C6'] \
    +specs['HEX3ONAOH']+specs['HEX3ONCOH']+specs['HCOC5']+specs['C2H5CHO']+specs['C113NO3'] \
    +specs['MPRKAOH']+specs['NC6H14']+specs['C5H8']+specs['CO2M3C5OH']+specs['CO2MC5OH'] \
    +specs['C93OOH']+specs['C6CO3HO4']+specs['DECOH']+specs['M3PECOH']+specs['M33C3CHO'] \
    +specs['M2PECOOH']+specs['C3H6']+specs['HO7C8OOH']+specs['C3H8']+specs['PRCOOPRONE'] \
    +specs['CO2HO4C6']+specs['CYHXOLACO']+specs['C78CO']+specs['CO2C43CHO']+specs['C2H6'] \
    +specs['C2H4']+specs['M2HEXAOH']+specs['CBUT2ENE']+specs['M23C43OOH']+specs['M3HEXBOH'] \
    +specs['CO36C11']+specs['CO36C12']+specs['M2PEDOOH']+specs['MBO']+specs['TBUT2ENE'] \
    +specs['CO36C9']+specs['CO1C6OH']+specs['M3PEBOH']+specs['BUT1ENE']+specs['C125OOH'] \
    +specs['IPECOH']+specs['IPEAOH']+specs['M2PEDOH']+specs['HO34CO6C8']+specs['M3HEXAOOH'] \
    +specs['HEXAOOH']+specs['M3CO5C6']+specs['HO7CO10C12']+specs['CO3C4CHO']+specs['HEXBOOH'] \
    +specs['H2M4CO5C6']+specs['PE4E2CO']+specs['PGLYOX']+specs['CYC613DION']+specs['UDECNO3'] \
    +specs['HO2CO5C7']+specs['HO2CO5C6']+specs['CO356C10']+specs['CO356C11']+specs['CO356C12'] \
    +specs['HO14C6']+specs['C102OOH']+specs['DIEK']+specs['C103CO']+specs['HO36C12'] \
    +specs['HO36C10']+specs['HO2C54CHO']+specs['EIPK']+specs['C104OH']+specs['MACR'] \
    +specs['newMLC1']
