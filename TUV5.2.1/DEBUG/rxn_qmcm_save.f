...
* combine:
      ...
      OPEN(111,FILE='qytuv.dat')
      WRITE(112,*) airden(1),airden(nz/3),airden(2*nz/3),airden(nz)
      DO iw = 1, nw - 1
        WRITE(112,*) wl(iw),"    ",yg1(iw),"    ",yg4(iw),"    ",yg5(iw)
         DO i = 1, nz
...
* Assume total yield 1 at zero pressure
              ...
              IF (qy1_n0 .GT. 0.) THEN
                x = qy1_0/qy1_n0 - 1.
              print*,wl(iw),qy1_n0,qy1_0,qy2,qy3
                print*, wl(iw),x
               ELSE
                x = 0.
              ENDIF
...
!              qy1=1/(yg5(iw)+yg4(iw)*airden(i)/2.465E19)
            ...
            ENDIF
            IF(i==1) THEN
              WRITE(111,'(3(F7.3,3X))',advance='no') wl(iw),wc(iw),qy1_n0
             ELSEIF(i==nz/3) THEN
              WRITE(111,'(F7.3,3X)',advance='no') qy1
             ELSEIF(i==2*nz/3) THEN
              WRITE(111,'(F7.3,3X)',advance='no') qy1
             ELSEIF(i == nz) THEN
              WRITE(111,'(F7.3)') qy1
            ENDIF
