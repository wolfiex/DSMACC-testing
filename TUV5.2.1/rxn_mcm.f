...
*                                     (MCM standard)
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(2A)') ' O3 cross section for photolysis values',
     ...
     &                   ' calculated from Bass et al.'
       ELSEIF(mabs.EQ.5) THEN
        WRITE(kout,'(3A)') ' O3 cross section for photolysis values',
     &                     ' calculated with IUPAC low res. data',
     &                     ' interpolated between 362.5 and 410nm.'
       ELSEIF(mabs.EQ.6) THEN
        WRITE(kout,'(3A)') ' O3 cross section for photolysis values',
     &                     ' calculated with IUPAC low res. data',
     &                     ' forced to zero between 362.5 and 410nm.'
       ELSEIF(mabs.EQ.7) THEN
        WRITE(kout,'(3A)') ' O3 cross section for photolysis values',
     &                     ' calculated with IUPAC high res. data by',
     &                     ' Malicet et al. (1995).'
       ELSE
        STOP "'mabs' not defined for O3 photolysis."
      ENDIF
...
c      myld = kmats
      ...
      IF(vers==1 .OR. vers==2) THEN
        CONTiNUE
       ELSEIF(myld.EQ.kjpl87) THEN
        WRITE(kout,'(A)')
     &       ' O3 quantum yields from JPL 1987 evaluation.'
       ELSEIF(myld.EQ.kjpl92) THEN
        WRITE(kout,'(A)')
     &       ' O3 quantum yields from JPL 1992 evaluation.'
       ELSEIF(myld.EQ.kjpl97) THEN
        WRITE(kout,'(A)')
     &       ' O3 quantum yields from JPL 1997 evaluation.'
       ELSEIF(myld.EQ.kjpl00) THEN
        WRITE(kout,'(A)')
     &       ' O3 quantum yields from JPL 2000 evaluation.'
       ELSEIF(myld.EQ.kmich) THEN
        WRITE(kout,'(A)')
     &       ' O3 quantum yields from Michelsen et al. (1994).'
       ELSEIF(myld.EQ.kshet) THEN
        WRITE(kout,'(A)')
     &       ' O3 quantum yields from Shetter et al. (1996).'
       ELSEIF(myld.EQ.kmats) THEN
        WRITE(kout,'(A)')
     &       ' O3 quantum yields from Matsumi et al. (2002)'
        WRITE(kout,'(A)') '(same as JPL 2006 evaluation).'
       ELSEIF(myld.EQ.kiup) THEN
        WRITE(kout,'(A)')
     &       ' O3 quantum yields from IUPAC recommendation.'
       ELSE
        STOP "'myld' not defined for O3 photolysis."
      ENDIF
...
* 3 = Harder et al.
* 4 = JPL 2006, interpolating between midpoints of bins (TUV standard)
* 5 = JPL 2006, bin-to-bin interpolation
* 6 = IUPAC recommendation (MCM standard)
      ...
      IF(vers==1)THEN
       ...
       ELSEIF(vers==2)THEN
        mabs = 6
       ELSEIF(vers==0) THEN
        mabs = 6! set database used for xs and qy
       ELSE
        STOP "'vers' not set. Choose value between 0 and 2 in 'params'."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(2A)')
     &       ' NO2 cross section for photolysis values',
     &       ' from Davidson et al. (1988).'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(2A)')
     &       ' NO2 cross section for photolysis values',
     &       ' from JPL 1994 - 2002 evaluations.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &     ' NO2 cross section for photolysis values from Harder et al.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(2A)')
     &       ' NO2 cross section for photolysis values from JPL 2006,',
     &       ' interpolating between midpoints of bins.'
       ELSEIF(mabs.EQ.5) THEN
        WRITE(kout,'(2A)')
     &       ' NO2 cross section for photolysis values from JPL 2006,',
     &       ' bin-to-bin interpolation.'
       ELSEIF(mabs.EQ.6) THEN
        WRITE(kout,'(2A)')
     &       ' NO2 cross section for photolysis values',
     &       ' from IUPAC recommendation.'
       ELSE
        STOP "'mabs' not defined for NO2 photolysis."
      ENDIF
...
*     myld = 3   NO2_IUPAC.yld (IUPAC recommendation) (MCM standard)
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' NO2 quantum yields from JPL 2002 evaluation.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' NO2 quantum yields from JPL 2006 evaluation.'
       ELSEIF(myld.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' NO2 quantum yields from IUPAC recommendation.'
       ELSE
        STOP "'myld' not defined for NO2 photolysis."
      ENDIF
...
* mabs = 2:  JPL94
* mabs = 3:  JPL11 (TUV standard)
* mabs = 4:  IUPAC (MCM standard)
      ...
      IF(vers==1)THEN
       ...
       ELSEIF(vers==2)THEN
        mabs = 4
       ELSEIF(vers==0) THEN
        mabs = 4! set database used for xs and qy
       ELSE
        STOP "'vers' not set. Choose value between 0 and 2 in 'params'."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' NO3 cross section from Graham and Johnston (1978).'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' NO3 cross section from JPL 1994 evaluation.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(2A)')
     &       ' NO3 cross section from JPL 2011 evaluation.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(A)')
     &       ' NO3 cross section from IUPAC recommendation.'
       ELSE
        STOP "'mabs' not defined for NO3 photolysis."
      ENDIF
...
*           (MCM standard)
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' NO3 quantum yields from Madronich (1988).'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' NO3 quantum yields from JPL 2011 evaluation.'
       ELSEIF(myld.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' NO3 quantum yields from IUPAC & JPL recommendation.'
       ELSE
        STOP "'myld' not defined for NO3 photolysis."
      ENDIF
...
* mabs = 1:  JPL 2006 and older recommendations
* mabs = 2:  JPL 2011 recommendation (TUV standard)
* mabs = 3:  IUPAC recommendation (forced to 0 between 280 and 295nm) (MCM standard)
* mabs = 4:  IUPAC recommendation (TUV interpolated between 280 and 295nm)
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' HNO2 cross section from JPL 2006 or older recommendation.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' HNO2 cross section from JPL 2011 recommendation.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(2A)')
     &       ' HNO2 cross section from IUPAC forced to 0',
     &       ' between 280 and 295nm.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(2A)')
     &       ' HNO2 cross section from IUPAC TUV interpolated',
     &       ' between 280 and 295nm.'
       ELSE
        STOP "'mabs' not defined for HNO2 photolysis."
      ENDIF
...
* mabs = 1 JPL 1985 recommendation
* mabs = 2 TUV provided Burkholder et al. 1993 data (TUV standard)
* mabs = 3 IUPAC recommended Burkholder et al. 1993 data (MCM standard)
      ...
      IF(vers==1)THEN
       ...
       ELSEIF(vers==2)THEN
        mabs = 3
       ELSEIF(vers==0) THEN
        mabs = 3! set database used for xs and qy
       ELSE
        STOP "'vers' not set. Choose value between 0 and 2 in 'params'."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' HNO3 cross section from JPL 1985 recommendation.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' HNO3 cross section from TUV provided Burkholder data.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &     ' HNO3 cross section from IUPAC recommended Burkholder data.'
       ELSE
        STOP "'mabs' not defined for HNO3 photolysis."
      ENDIF
...
!                 • HONO + O(1D)
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' HNO3 quantum set to unity.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' HNO3 quantum yields from IUPAC recommendation.'
       ELSE
        STOP "'myld' not defined for HNO3 photolysis."
      ENDIF
...
* mabs = 1 JPL 2011 recommendation (TUV standard)
* mabs = 2 IUPAC recommendation (MCM standard)
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' HNO4 cross section from JPL 2011.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' HNO4 cross section from IUPAC.'
       ELSE
        STOP "'mabs' not defined for HNO4 photolysis."
      ENDIF
...
*--------------- MCM standard version ----------------------------------
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' HNO4 quantum yields set to 1 (TUV standard).'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &    ' HNO4 quantum yields from IUPAC (MCM standard).'
       ELSE
        STOP "'myld' not defined for HNO4 photolysis."
      ENDIF
...
* mabs = 1 old TUV data
* mabs = 2 JPL 1994 recommendation (TUV standard)
* mabs = 3 IUPAC recommendation (MCM standard)
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' H2O2 cross section from old TUV data.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' H2O2 cross section from JPL94.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' H2O2 cross section from IUPAC.'
       ELSE
        STOP "'mabs' not defined for H2O2 photolysis."
      ENDIF
...
* quantum yields
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' H2O2 quantum yields set to 1 (TUV standard).'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &    ' H2O2 quantum yields set to 1 for wavelengths greater 220nm'
        WRITE(kout,'(A)')
     &    '      and to 0.85 else (IUPAC recommended).'
       ELSE
        STOP "'myld' not defined for H2O2 photolysis."
      ENDIF
...
* Input data options:
* options for absorption (mabs):
* 1:  JPL 2011 recommendataion (TUV standard)
* 2:  IUPAC 2013 recommendation: T-indep. high resolution data
* 3:  IUPAC 2013 recommendation: T-dep. low resolution data
* 4:  IUPAC 2013 recommendation: high res. data with T-dep. between 251.7 and 350nm
*     (MCM standard)

* options for quantum yields (myld):
* 1:  JPL 2011 (TUV standard)
* 2:  IUPAC recommendation (MCM standard)
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' HCHO cross section from JPL 2011.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' HCHO cross section from IUPAC high res. data.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' HCHO cross section from IUPAC T-dep. low res. data.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(A)')
     & ' HCHO cross section from IUPAC mixed high res. data with T-dep.'
       ELSE
        STOP "'mabs' not defined for HCHO photolysis."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' HCHO quantum yields from JPL 2011.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' HCHO quantum yields from IUPAC 2013'
       ELSE
        STOP "'myld' not defined for HCHO photolysis."
      ENDIF
...
* read IUPAC 2013 high res. data
     ...
     $        ,STATUS='old')
         ...
         n = 150
         DO i = 1, n
            READ(kin,*) idum, y298(i)
            x1(i) = FLOAT(idum)
         ENDDO
         CALL addpnt(x1,y298,kdata,n,x1(1)*(1.-deltax),0.)
         CALL addpnt(x1,y298,kdata,n,               0.,0.)
         CALL addpnt(x1,y298,kdata,n,x1(n)*(1.+deltax),0.)
         CALL addpnt(x1,y298,kdata,n,           1.e+38,0.)
         CALL inter2(nw,wl,yg1,n,x1,y298,ierr)
         IF (ierr .NE. 0) THEN
            WRITE(*,*) ierr, jlabel(j-1)
            STOP
         ENDIF
...
* Absorption:
* 1:  IUPAC-97 - 2013 data, from Martinez et al.
* 2:  Calvert and Pitts
* 3:  Martinez et al., Table 1 scanned from paper
...
* 3:  new IUPAC 2013 recommendation
*     DATAJ1/CH3CHO/CH3CHO_iup13.yld
*     with T/p-dependence: DATAJ1/CH3CHO/CH3CHO_pdep_iup13.yld
      ...
      IF(vers==1)THEN
       ...
       ELSEIF(vers==2)THEN
        mabs = 1
       ELSEIF(vers==0) THEN
        mabs = 1! set database used for xs and qy
       ELSE
        STOP "'vers' not set. Choose value between 0 and 2 in 'params'."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' CH3CHO cross section from IUPAC.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3CHO cross section from Calvert and Pitts.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' CH3CHO cross section from Martinez et al.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(A)')
     &       ' CH3CHO cross section from KFA tabulations.'
       ELSEIF(mabs.EQ.5) THEN
        WRITE(kout,'(A)')
     &       ' CH3CHO cross section from JPL 2011.'
       ELSE
        STOP "'mabs' not defined for CH3CHO photolysis."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
        CONTiNUE
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)') ' CH3CHO quantum yields from IUPAC 97.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)') ' CH3CHO quantum yields from NCAR.'
       ELSEIF(myld.EQ.3) THEN
        WRITE(kout,'(A)') ' CH3CHO quantum yields from IUPAC 2013.'
       ELSE
        STOP "'myld' not defined for CH3CHO photolysis."
      ENDIF
...
* pressure-dependence parameters
      ...
      IF(vers==1 .OR. vers==2) THEN
        CONTiNUE
       ELSEIF(mpress.EQ.1) THEN
        WRITE(kout,'(2A)')
     &       ' CH3CHO quantum yield pressure dependence',
     &       ' estimated from IUPAC 2006.'
       ELSEIF(mpress.EQ.2) THEN
        WRITE(kout,'(2A)')
     &       ' CH3CHO quantum yield pressure dependence',
     &       ' from IUPAC 2013.'
       ELSE
        STOP "'mpress' not defined for CH3CHO photolysis."
      ENDIF
...
!    &            1./(yg5(iw)+yg4(iw)*airden(i)/2.465E19)))
             ELSEIF(mpress==2) THEN
              press = MAX(0.,MIN(1.,1./(1./yg4(iw)+yg5(iw)*airden(i))))
              qytot = qy1+qy2+qy3
...
* 2:  IUPAC 2002 data
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' C2H5CHO cross section from IUPAC.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' C2H5CHO cross section from Calvert and Pitts.'
       ELSE
        STOP "'mabs' not defined for C2H5CHO photolysis."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' C2H5CHO quantum yields from IUPAC 97.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' C2H5CHO quantum yields from IUPAC 2002.'
       ELSEIF(myld.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' C2H5CHO quantum yields from Calvert et al. 2011.'
       ELSE
        STOP "'myld' not defined for C2H5CHO photolysis."
      ENDIF
...
* quantum yields
     ...
     $        STATUS='old')
         ...
         CALL addpnt(x1,y1,kdata,n,x1(1)*(1.-deltax),0.)
         CALL addpnt(x1,y1,kdata,n,               0.,0.)
         CALL addpnt(x1,y1,kdata,n,x1(n)*(1.+deltax),1.)
         CALL addpnt(x1,y1,kdata,n,           1.e+38,1.)
         CALL inter2(nw,wl,yg1,n,x1,y1,ierr)
         IF (ierr .NE. 0) THEN
            WRITE(*,*) ierr, jlabel(j)
            STOP
...
* 3:  Salter et al. 2013
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' CHOCHO cross section from IUPAC 97.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CHOCHO cross section from KFA.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' CHOCHO cross section from Orlando and Tyndall 2001.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(A)')
     &       ' CHOCHO cross section from Horrowitz et al. 2001.'
       ELSEIF(mabs.EQ.5) THEN
        WRITE(kout,'(A)')
     &       ' CHOCHO cross section from JPL 2011 (also in IUPAC 2013).'
       ELSE
        STOP "'mabs' not defined for CHOCHO photolysis."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CHOCHO quantum yields from IUPAC 97.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CHOCHO quantum yields from JPL 2011.'
       ELSEIF(myld.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' CHOCHO quantum yields from Salter et al. 2013.'
       ELSE
        STOP "'myld' not defined for CHOCHO photolysis."
      ENDIF
...
* qyI is the sum of their channels P1a, P1b, and P1g
     ...
     &           + 0.28/(1.+EXP((wc(iw)-276.7)/12.))
         ...
         DO i = 1, nz
           ...
           IF(myld==3) THEN
* calculate pressure dependency of total qy:
     ...
     &        * (1.e7/wc(iw)-2.38e4))
           ...
           qy = min(1.,max(0.,(1+A2+A3*airden(i))/
...
* 7:  Quantum yields from IUPAC (2003) assumed as air
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO cross section from IUPAC.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(2A)')
     &       ' CH3COCHO cross section average of',
     &       ' Staffelbach et al. 1995 and Meller et al. 1991.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO cross section from Plum et al. 1983.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(A)')
     &      ' CH3COCHO high res. cross section from Meller et al. 1991.'
       ELSEIF(mabs.EQ.5) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO cross section from Meller et al. 1991.'
       ELSEIF(mabs.EQ.6) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO cross section Staffelbach et al. 1995.'
       ELSEIF(mabs.EQ.7) THEN
        WRITE(kout,'(2A)')
     &       ' CH3COCHO cross section synthesised from',
     &       ' glyoxal and biacetyl cross sections.'
       ELSEIF(mabs.EQ.8) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO cross section from JPL 2011.'
       ELSE
        STOP "'mabs' not defined for CH3COCHO photolysis."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO quantum yields from Plum et al.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO quantum yields from Plum et al. divided by 2.'
       ELSEIF(myld.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO quantum yields from Staffelbach et al.'
       ELSEIF(myld.EQ.4) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO quantum yields from Koch and Moortgat.'
       ELSEIF(myld.EQ.5) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO quantum yields from Chen, Y. et al.'
       ELSEIF(myld.EQ.6) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCHO quantum yields from IUPAC in N2.'
       ELSE
        STOP "'myld' not defined for CH3COCHO photolysis."
      ENDIF
...
*       Res. Lett., 31, L06111, doi:10.1029/2003GL018793.
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH3 cross section from Calvert and Pitts.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH3 cross section from IUPAC 1997.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH3 cross section from NOAA 1998.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH3 cross section from JPL 2011 / IUPAC 2013.'
       ELSE
        STOP "'mabs' not defined for CH3COCH3 photolysis."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH3 quantum yields from Gardiner et al. 1984.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH3 quantum yields from IUPAC 97.'
       ELSEIF(myld.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH3 quantum yields from McKeen et al. 1997.'
       ELSEIF(myld.EQ.4) THEN
        WRITE(kout,'(A)')
     &  ' CH3COCH3O quantum yields from Blitz et al. 2004 (IUPAC 2013).'
       ELSE
        STOP "'myld' not defined for CH3COCH3 photolysis."
      ENDIF
...
* 5:  JPL2011
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CH3OOH cross section from JPL 85 - 02.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3OOH cross section from IUPAC 1997.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' CH3OOH cross section from Cox and Tyndall 1978.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(A)')
     &       ' CH3OOH cross section from Molina and Arguello (1979).'
       ELSEIF(mabs.EQ.5) THEN
        WRITE(kout,'(A)')
     &       ' CH3OOH cross section from JPL 2011.'
       ELSE
        STOP "'mabs' not defined for CH3OOH photolysis."
      ENDIF
...
*10:  IUPAC (2002) recommendation
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CH3NO3 cross section from Calvert and Pitts (1966).'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3NO3 cross section from Talukdar et al. (1997).'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' CH3NO3 cross section at 298K from IUPAC 1997.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(A)')
     &       ' T-dep. CH3NO3 cross section from IUAPC 1997.'
       ELSEIF(mabs.EQ.5) THEN
        WRITE(kout,'(A)')
     &       ' CH3NO3 cross section from Taylor et al. (1980).'
       ELSEIF(mabs.EQ.6) THEN
        WRITE(kout,'(A)')
     &  ' CH3NO3 cross section from fitted Roberts and Fajer 1989 data.'
       ELSEIF(mabs.EQ.7) THEN
        WRITE(kout,'(A)')
     &       ' CH3NO3 cross section from Rattigan et al. (1992).'
       ELSEIF(mabs.EQ.8) THEN
        WRITE(kout,'(A)')
     &       ' CH3NO3 cross section from Libuda and Zabel (1995).'
       ELSEIF(mabs.EQ.9) THEN
        WRITE(kout,'(A)')
     &       ' CH3NO3 cross section from JPL 2011.'
       ELSEIF(mabs.EQ.10) THEN
        WRITE(kout,'(A)')
     &       ' CH3NO3 cross section from IUPAC 2002.'
       ELSE
        STOP "'mabs' not defined for CH3OOH photolysis."
      ENDIF
...
* 3: from Calvert et al. 2011 book (ammended by values at 248nm from IUPAC)
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' PAN quantum yields from JPL.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' PAN quantum yields from IUPAC.'
       ELSEIF(myld.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' PAN quantum yields from the book of Calvert et al. 2011.'
       ELSE
        STOP "'myld' not defined for PAN photolysis."
      ENDIF
...
************************* CH2(OH)CHO photolysis
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' HOCH2CHO cross section from IUPAC.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' HOCH2CHO cross section from JPL.'
       ELSE
        STOP "'mabs' not defined for HOCH2CHO photolysis."
      ENDIF
...
* mabs = 2 Horowitz et al.
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' CH3COCOCH3 cross section from Plum et al.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCOCH3 cross section from Horowitz et al.'
       ELSE
...
* mabs = 2: jpl 2011/IUPAC
      ...
      IF(vers==1)THEN
       ...
       ELSEIF(vers==2)THEN
        mabs = 2
       ELSEIF(vers==0) THEN
        mabs = 2! set database used for xs and qy
       ELSE
        STOP "'vers' not set. Choose value between 0 and 2 in 'params'."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' MVK cross section from Schneider and Moortgat.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' MVK cross section from JPL/IUPAC.'
       ELSE
        STOP "'mabs' not defined for MVK photolysis."
      ENDIF
...
* local
      ...
      real qy, qy1, qy2, qy3, qy4, qyoh
      REAL sig, sigoh
      INTEGER ierr, idum, myld, mprod
...
* same channels estimated as for acrolein
      ...
      j = j+1
      jlabel(j) = 'MACROHqy -> NI products'
      j = j+1
      jlabel(j) = 'MACROHqy -> alkene + CO'
      j = j+1
      jlabel(j) = 'MACROHqy -> acyl + H'
      j = j+1
      jlabel(j) = 'MACROHoh -> NI products'
      j = j+1
      jlabel(j) = 'MACROHoh -> alkene + CO'
      j = j+1
      jlabel(j) = 'MACROHoh -> acyl + H'
...
* or estimates by Calvert et al. (2011)
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' MACR quantum yields estimated with 0.1 (upper limit).'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' MACR quantum yields from Calvert et al. 2011.'
       ELSE
        STOP "'myld' not defined for MACR photolysis."
      ENDIF
...
* 2: assuming CH3CH: + M -> C2H4 + M for main channel
      ...
      IF(vers==1 .OR. vers==2) THEN
        CONTiNUE
       ELSEIF(mprod.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' Criegie formation in methacrolein main channel.'
       ELSEIF(mprod.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' Propylene formation in methacrolein main channel.'
       ELSE
        STOP "'mprod' not defined for methacrolein photolysis."
      ENDIF
     ...
     &                +0.0788*airden(i)/1.E19+0.1029)
           ...
           sq(j-3,i,iw) = sigoh * qy4
           sq(j-2,i,iw) = sigoh * qyoh*qy1/(qy1+qy2+qy4)
           sq(j-1,i,iw) = sigoh * qyoh*qy2/(qy1+qy2+qy4)
           sq(j  ,i,iw) = sigoh * qyoh*qy4/(qy1+qy2+qy4)
           IF(qy1+qy2+qy4 > 0.) THEN
             sq(j-2,i,iw) = sigoh * qyoh*qy1/(qy1+qy2+qy4)
             sq(j-1,i,iw) = sigoh * qyoh*qy2/(qy1+qy2+qy4)
             sq(j  ,i,iw) = sigoh * qyoh*qy4/(qy1+qy2+qy4)
            ELSE
...
* mabs = 2:  JPL2011
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCOOH cross sections from Horowitz et al.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCOOH cross sections from JPL 2011.'
       ELSE
        STOP "'mabs' not defined for CH3COCOOH photolysis."
      ENDIF


* myld = 1:  from TUV, no product determination
* myld = 2:  JPL2011
      IF(vers==1)THEN
        myld = 1
       ELSEIF(vers==2)THEN
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(2A)')
     &       ' CH3COCOOH quantum yields from TUV',
     &       ' (1, no product determination).'
        jlabel(j-3) = 'CH3COCOOH -> products' ! adjust jlabel for TUV qy
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCOOH quantum yields from JPL 2011.'
       ELSE
        STOP "'myld' not defined for CH3COCOOH photolysis."
      ENDIF
...
************************* CH3CHONO2CH3 photolysis
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' i-C3H7NO3 cross section from Talukdar et al.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' i-C3H7NO3 cross section from IUPAC.'
       ELSE
        STOP "'mabs' not defined for i-C3H7NO3 photolysis."
      ENDIF
...
************************* CH3COCH2(ONO2) photolysis
      ...
      IF(vers==1)THEN
        mabs = 2 !From GECKO-A TUV version (Bernard Aumont group), not TUV5.2
       ELSEIF(vers==2)THEN
        mabs = 6
       ELSEIF(vers==0) THEN
        mabs = 2
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(2A)')
     &       ' CH3COCH2NO3 cross sections from least square fit',
     &       ' by Barnes et al.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &  ' CH3COCH2NO3 cross sections from data by Barnes et al.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(2A)')
     &       ' CH3COCH2NO3 cross sections from least square fit',
     &       ' by Roberts and Fajer.'
       ELSEIF(mabs.EQ.4) THEN
        WRITE(kout,'(A)')
     &  ' CH3COCH2NO3 cross sections from data by Roberts and Fajer.'
       ELSEIF(mabs.EQ.5) THEN
        WRITE(kout,'(2A)')
     &       ' CH3COCH2NO3 cross sections from average of',
     &       ' least square fits by Barnes et al./Roberts and Fajer.'
       ELSEIF(mabs.EQ.6) THEN
        WRITE(kout,'(2A)')
     &       ' CH3COCH2NO3 cross sections from average of',
     &       ' data by Barnes et al./Roberts and Fajer.'
       ELSE
        STOP "'mabs' not defined for CH3COCH2NO3 photolysis."
      ENDIF


      IF(vers==1)THEN
        myld = 2 !From GECKO-A TUV version (Bernard Aumont group), not TUV5.2
       ELSEIF(vers==2)THEN
        myld = 2
       ELSEIF(vers==0) THEN
        myld = 2
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &  ' CH3COCH2NO3 quantum yields estimated 1 (Calvert et al.).'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     & ' CH3COCH2NO3 quantum yields estimated 0.9 (Muller et al.).'
       ELSE
        STOP "'myld' not defined for CH3COCH2NO3 photolysis."
      ENDIF


      IF(mabs==2 .or. mabs==6) THEN
...
* mabs = 1:  from Orlando et al. 1999 (IUPAC)
* mabs = 2:  from jpl 2011
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH2OH cross sections from IUPAC.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH2OH cross sections from JPL.'
       ELSEIF(mabs.EQ.3) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH2OH cross sections from Messaadia et al.'
       ELSE
        STOP "'mabs' not defined for CH3COCH2OH photolysis."
      ENDIF
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH2OH quantum yields from Orlando et al. 2006.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3COCH2OH quantum yields from IUPAC.'
       ELSE
        STOP "'myld' not defined for CH3COCH2OH photolysis."
      ENDIF
...
* Assume equal for each of the two channels
...
* IUPAC recommendation of 0.34 with quenching from above
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' MEK quantum yields from Raber, W.H. (1992).'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' MEK quantum yields from IUPAC.'
       ELSE
        STOP "'myld' not defined for MEK photolysis."
      ENDIF
...
**************** PPN photodissociation
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' PPN quantum yields from Harwood et al.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' PPN quantum yield estimates from Calvert et al. 2011.'
       ELSE
        STOP "'myld' not defined for PPN photolysis."
      ENDIF
...
* quantum yields
      ...
      IF(myld == 1) THEN
       ...
       ELSEIF(myld == 2) THEN
        ...
        CALL addpnt(x1,y1,kdata,n1,x1(1)*(1.-deltax),x1(1))
        CALL addpnt(x1,y1,kdata,n1,               0.,x1(1))
        CALL addpnt(x1,y1,kdata,n1,x1(n1)*(1.+deltax),x1(n1))
        CALL addpnt(x1,y1,kdata,n1,           1.e+38,x1(n1))
        CALL inter2(nw,wl,yg2,n1,x1,y1,ierr)
        IF (ierr .NE. 0) THEN
          WRITE(*,*) ierr, jlabel(j)
          STOP
        ...
        CALL addpnt(x2,y2,kdata,n2,x2(1)*(1.-deltax),x1(1))
        CALL addpnt(x2,y2,kdata,n2,          0.,x1(1))
        CALL addpnt(x2,y2,kdata,n2,x2(n2)*(1.+deltax),x1(n2))
        CALL addpnt(x2,y2,kdata,n2,      1.e+38,x1(n2))
        CALL inter2(nw,wl,yg3,n2,x2,y2,ierr)
        IF (ierr .NE. 0) THEN
          WRITE(*,*) ierr, jlabel(j)
          STOP
...
* 1:     IUPAC 2002
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' HOCH2OOH cross section from JPL.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' HOCH2OOH cross section from IUPAC.'
       ELSE
        STOP "'mabs' not defined for HOCH2OOH photolysis."
      ENDIF
...
* local
      ...
      REAL yg(kw), ygoh(kw)
      real qy, qym1, qy1, qy2, qy3, qy4, qyoh
      REAL sig, sigoh
      INTEGER ierr, idum

      INTEGER mabs, myld, mprod
...
**************** acrolein photodissociation
      ...
      j = j+1
      jlabel(j) = 'ACROHqy -> NI products'
      j = j+1
      jlabel(j) = 'ACROHqy -> alkene + CO'
      j = j+1
      jlabel(j) = 'ACROHqy -> acyl + H'
      j = j+1
      jlabel(j) = 'ACROHoh -> NI products'
      j = j+1
      jlabel(j) = 'ACROHoh -> alkene + CO'
      j = j+1
      jlabel(j) = 'ACROHoh -> acyl + H'

* cross section from
* 1: JPL 2006 (originally from Magneron et al.)
* 2: Calvert et al. 2011
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' Acrolein cross section from JPL.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' Acrolein cross section from Calvert et al. 2011.'
       ELSE
        STOP "'mabs' not defined for acrolein photolysis."
      ENDIF
...
* 2: from Calvert et al. 2011
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' Acrolein quantum yields from JPL.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' Acrolein quantum yields from Calvert et al. 2011.'
       ELSE
        STOP "'myld' not defined for acrolein photolysis."
      ENDIF
...
* 2: assuming CH3CH: + M -> C2H4 + M for main channel
      IF(vers==1)THEN
        mprod = 1 ! according to GECKO-A estimates
       ELSEIF(vers==2)THEN
        mprod = 2 ! based on Gardner et al. 1987 and JPL
       ELSEIF(vers==0) THEN
        mprod = 2
       ELSE
        STOP "'vers' not set. Choose value between 0 and 2 in 'params'."
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mprod.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' Criegie formation in acrolein main channel.'
       ELSEIF(mprod.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' Ethylene formation in acrolein main channel.'
       ELSE
        STOP "'mprod' not defined for acrolein photolysis."
      ENDIF
...
* quantum yields assumed unity
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(myld.EQ.1) THEN
        WRITE(kout,'(A)')
     &       ' CH3NO4 quantum yields set to 1.'
       ELSEIF(myld.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' CH3NO4 quantum yields estimated same as HNO4.'
       ELSE
        STOP "'myld' not defined for CH3NO4 photolysis."
      ENDIF
...
* Absorption cross section options:
* 1: Talukdar et al.
* 2: IUPAC
      ...
      IF(vers==1 .OR. vers==2) THEN
       ...
       ELSEIF(mabs.EQ.1) THEN
        WRITE(kout,'(A)')
     &      ' C2H5NO3 cross section from Talukdar et al.'
       ELSEIF(mabs.EQ.2) THEN
        WRITE(kout,'(A)')
     &       ' C2H5NO3 cross section from IUPAC.'
       ELSE
        STOP "'mabs' not defined for C2H5NO3 photolysis."
      ENDIF
