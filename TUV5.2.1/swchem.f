...
*=           reaction defined                                                =*
*=  LCL    - INTEGER, length of character for jlabel                         =*
*-----------------------------------------------------------------------------*
...
*C7.  HNO3 + hv -> OH + NO2 (+ 4 minor channels)
      CALL r06(nw,wl,wc,nz,tlev,airden,j,sq,jlabel)

*C8.  HNO4 + hv -> HO2 + NO2 / OH + NO3
...
*G10. BrONO2 + hv -> Products (both channels)
