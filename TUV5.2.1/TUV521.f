...
* I/O variables:
      ...
      !r03col 290 - 350
      !albedo 0-1 
      !altitude/pressure 0 - 15?
      !temp
      !sza 0 - 95
      !added nt =1 to tuv so a single sza value is calculated only 
...
!     print date and time into logfile:
      CALL DATE_AND_TIME(DATE, TIME, ZONE, TVAL)
      WRITE(kout,'(A)',advance='no') 'Model run from: '
      WRITE(kout,'(I2,".",I2".",I4,", ",I2,":",I2)')
     &      tval(3),tval(2),tval(1),tval(5),tval(6)
