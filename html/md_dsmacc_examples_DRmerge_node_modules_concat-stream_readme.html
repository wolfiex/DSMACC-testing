...
<title>DSMACC: concat-stream</title>
...
<div class="fragment"><div class="line">var write = concat(function(data) {})</div><div class="line">var a = new Uint8Array(3)</div><div class="line">a[0] = 97; a[1] = 98; a[2] = 99</div><div class="line">write.write(a)</div><div class="line">write.write(&#39;!&#39;)</div><div class="line">write.end(Buffer.from(&#39;!!1&#39;))</div></div><!-- fragment --><p>See <code>test/</code> for more examples</p>
<h1>methods</h1>
