...
<li>Renamed <code>nend</code> to <code>nodeify</code>. It no longer returns an always-fulfilled promise when a <a class="el" href="classNode.html">Node</a> callback is passed.</li>
...
<li>Fixed <code>ninvoke</code> and <code>npost</code> to work on promises for objects with <a class="el" href="classNode.html">Node</a> methods. #134</li>
<li>Fixed accidental coercion of objects with nontrivial <code>valueOf</code> methods, like <code><a class="el" href="classDate.html">Date</a></code>s, by the promise's <code>valueOf</code> method. #135</li>
...
<li>Added <code>defer().<a class="el" href="structnode.html">node()</a></code> <a class="el" href="classNode.html">Node</a> callback generator. The callback accepts <code>(error, value)</code> or <code>(error, ...values)</code>. For multiple value arguments, the fulfillment value is an array, useful in conjunction with <code>spread</code>.</li>
...
<li>Added <code>end</code> as both an API method and a promise-chain ending method. It causes propagated rejections to be thrown, which allows <a class="el" href="classNode.html">Node</a> to write stack traces and emit <code>uncaughtException</code> events, and browsers to likewise emit <code>onerror</code> and log to the console.</li>
...
<ul>
<li>*Removed the utility modules. NPM and <a class="el" href="classNode.html">Node</a> no longer expose any module except the main module. These have been moved and merged into the "qq" package.</li>
...
<li>Exceptions thrown in the callbacks of a <code>when</code> call are now emitted to <a class="el" href="classNode.html">Node</a>'s <code>"uncaughtException"</code> <code>process</code> event in addition to being returned as a rejection reason.</li>
</ul>
<h2>0.2.8</h2>
<ul>
