...
<title>DSMACC: Chokidar [![Weekly downloads](https://img.shields.io/npm/dw/chokidar.svg)](https://github.com/paulmillr/chokidar) [![Yearly downloads](https://img.shields.io/npm/dy/chokidar.svg)](https://github.com/paulmillr/chokidar)</title>
...
<div class="title">Chokidar [![Weekly downloads](<a href="https://img.shields.io/npm/dw/chokidar.svg">https://img.shields.io/npm/dw/chokidar.svg</a>)](<a href="https://github.com/paulmillr/chokidar">https://github.com/paulmillr/chokidar</a>) [![Yearly downloads](<a href="https://img.shields.io/npm/dy/chokidar.svg">https://img.shields.io/npm/dy/chokidar.svg</a>)](<a href="https://github.com/paulmillr/chokidar">https://github.com/paulmillr/chokidar</a>) </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><blockquote class="doxtable">
<p>A neat wrapper around node.js fs.watch / fs.watchFile / FSEvents. </p>
</blockquote>
<p><a href="https://www.npmjs.com/package/chokidar"></a></p>
...
<div class="fragment"><div class="line">npm install chokidar</div></div><!-- fragment --><p>Then <code>require</code> and use it in your code:</p>
<div class="fragment"><div class="line">const chokidar = require(&#39;chokidar&#39;);</div><div class="line"></div><div class="line">// One-liner for current directory</div><div class="line">chokidar.watch(&#39;.&#39;).on(&#39;all&#39;, (event, path) =&gt; {</div><div class="line">  console.log(event, path);</div><div class="line">});</div></div><!-- fragment --><h2>API</h2>
<div class="fragment"><div class="line">// Example of a more typical implementation structure:</div><div class="line"></div><div class="line">// Initialize watcher.</div><div class="line">const watcher = chokidar.watch(&#39;file, dir, glob, or array&#39;, {</div><div class="line">  ignored: /(^|[\/\\])\../, // ignore dotfiles</div><div class="line">  persistent: true</div><div class="line">});</div><div class="line"></div><div class="line">// Something to use when events are received.</div><div class="line">const log = console.log.bind(console);</div><div class="line">// Add event listeners.</div><div class="line">watcher</div><div class="line">  .on(&#39;add&#39;, path =&gt; log(`File ${path} has been added`))</div><div class="line">  .on(&#39;change&#39;, path =&gt; log(`File ${path} has been changed`))</div><div class="line">  .on(&#39;unlink&#39;, path =&gt; log(`File ${path} has been removed`));</div><div class="line"></div><div class="line">// More possible events.</div><div class="line">watcher</div><div class="line">  .on(&#39;addDir&#39;, path =&gt; log(`Directory ${path} has been added`))</div><div class="line">  .on(&#39;unlinkDir&#39;, path =&gt; log(`Directory ${path} has been removed`))</div><div class="line">  .on(&#39;error&#39;, error =&gt; log(`Watcher error: ${error}`))</div><div class="line">  .on(&#39;ready&#39;, () =&gt; log(&#39;Initial scan complete. Ready for changes&#39;))</div><div class="line">  .on(&#39;raw&#39;, (event, path, details) =&gt; { // internal</div><div class="line">    log(&#39;Raw event info:&#39;, event, path, details);</div><div class="line">  });</div><div class="line"></div><div class="line">// &#39;add&#39;, &#39;addDir&#39; and &#39;change&#39; events also receive stat() results as second</div><div class="line">// argument when available: http://nodejs.org/api/fs.html#fs_class_fs_stats</div><div class="line">watcher.on(&#39;change&#39;, (path, stats) =&gt; {</div><div class="line">  if (stats) console.log(`File ${path} changed size to ${stats.size}`);</div><div class="line">});</div><div class="line"></div><div class="line">// Watch new files.</div><div class="line">watcher.add(&#39;new-file&#39;);</div><div class="line">watcher.add([&#39;new-file-2&#39;, &#39;new-file-3&#39;, &#39;**/other-file*&#39;]);</div><div class="line"></div><div class="line">// Get list of actual paths being watched on the filesystem</div><div class="line">var watchedPaths = watcher.getWatched();</div><div class="line"></div><div class="line">// Un-watch some files.</div><div class="line">watcher.unwatch(&#39;new-file*&#39;);</div><div class="line"></div><div class="line">// Stop watching.</div><div class="line">watcher.close();</div><div class="line"></div><div class="line">// Full list of options. See below for descriptions. (do not use this example)</div><div class="line">chokidar.watch(&#39;file&#39;, {</div><div class="line">  persistent: true,</div><div class="line"></div><div class="line">  ignored: &#39;*.txt&#39;,</div><div class="line">  ignoreInitial: false,</div><div class="line">  followSymlinks: true,</div><div class="line">  cwd: &#39;.&#39;,</div><div class="line">  disableGlobbing: false,</div><div class="line"></div><div class="line">  usePolling: true,</div><div class="line">  interval: 100,</div><div class="line">  binaryInterval: 300,</div><div class="line">  alwaysStat: false,</div><div class="line">  depth: 99,</div><div class="line">  awaitWriteFinish: {</div><div class="line">    stabilityThreshold: 2000,</div><div class="line">    pollInterval: 100</div><div class="line">  },</div><div class="line"></div><div class="line">  ignorePermissionErrors: false,</div><div class="line">  atomic: true // or a custom &#39;atomicity delay&#39;, in milliseconds (default 100)</div><div class="line">});</div></div><!-- fragment --><p><code>chokidar.watch(paths, [options])</code></p>
<ul>
...
<h2>Changelog</h2>
<p>For more detailed changelog, see .github/full_changelog.md "`full_changelog.md`".</p>
<ul>
<li><b>v3.1 (Sep 16, 2019):</b> dotfiles are no longer filtered out by default. Use <code>ignored</code> option if needed. Improve Linux performance by 50%.</li>
...
<li><b>v1 (Apr 7, 2015):</b> Glob support, symlink support, tons of bugfixes. <a class="el" href="classNode.html">Node</a> 0.8+ is supported</li>
