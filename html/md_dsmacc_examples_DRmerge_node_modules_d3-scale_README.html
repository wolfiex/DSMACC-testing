...
<div class="title">d3-scale </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p>Scales are a convenient abstraction for a fundamental task in visualization: mapping a dimension of abstract data to a visual representation. Although most often used for position-encoding quantitative data, such as mapping a measurement in meters to a position in pixels for dots in a scatterplot, scales can represent virtually any visual encoding, such as diverging colors, stroke widths, or symbol size. Scales can also be used with virtually any type of data, such as named categorical data or discrete data that requires sensible breaks.</p>
...
<ul>
<li><a href="https://medium.com/@mbostock/introducing-d3-scale-61980c51545f">Introducing d3-scale</a> by Mike Bostock</li>
<li><a href="http://chimera.labs.oreilly.com/books/1230000000345/ch07.html">Chapter 7. Scales</a> of <em>Interactive Data Visualization for the Web</em> by Scott Murray</li>
<li><a href="http://www.jeromecukier.net/blog/2011/08/11/d3-scales-and-color/">d3: scales, and color.</a> by Jérôme Cukier</li>
</ul>
<h2>Installing</h2>
...
<div class="fragment"><div class="line">&lt;script src=&quot;https://d3js.org/d3-array.v1.min.js&quot;&gt;&lt;/script&gt;</div><div class="line">&lt;script src=&quot;https://d3js.org/d3-collection.v1.min.js&quot;&gt;&lt;/script&gt;</div><div class="line">&lt;script src=&quot;https://d3js.org/d3-color.v1.min.js&quot;&gt;&lt;/script&gt;</div><div class="line">&lt;script src=&quot;https://d3js.org/d3-format.v1.min.js&quot;&gt;&lt;/script&gt;</div><div class="line">&lt;script src=&quot;https://d3js.org/d3-interpolate.v1.min.js&quot;&gt;&lt;/script&gt;</div><div class="line">&lt;script src=&quot;https://d3js.org/d3-time.v1.min.js&quot;&gt;&lt;/script&gt;</div><div class="line">&lt;script src=&quot;https://d3js.org/d3-time-format.v2.min.js&quot;&gt;&lt;/script&gt;</div><div class="line">&lt;script src=&quot;https://d3js.org/d3-scale.v1.min.js&quot;&gt;&lt;/script&gt;</div><div class="line">&lt;script&gt;</div><div class="line"></div><div class="line">var x = d3.scaleLinear();</div><div class="line"></div><div class="line">&lt;/script&gt;</div></div><!-- fragment --><p>(You can omit d3-time and d3-time-format if you’re not using <a href="#scaleTime">d3.scaleTime</a> or <a href="#scaleUtc">d3.scaleUtc</a>.)</p>
...
<p><a class="anchor" id="_continuous"></a># <em>continuous</em>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/continuous.js#L69" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">var x = d3.scaleLinear()</div><div class="line">    .domain([10, 130])</div><div class="line">    .range([0, 960]);</div><div class="line"></div><div class="line">x(20); // 80</div><div class="line">x(50); // 320</div></div><!-- fragment --><p>Or to apply a color encoding:</p>
<div class="fragment"><div class="line">var color = d3.scaleLinear()</div><div class="line">    .domain([10, 100])</div><div class="line">    .range([&quot;brown&quot;, &quot;steelblue&quot;]);</div><div class="line"></div><div class="line">color(20); // &quot;#9a3439&quot;</div><div class="line">color(50); // &quot;#7b5167&quot;</div></div><!-- fragment --><p><a class="anchor" id="continuous_invert"></a># <em>continuous</em>.<b>invert</b>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/continuous.js#L88" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">var x = d3.scaleLinear()</div><div class="line">    .domain([10, 130])</div><div class="line">    .range([0, 960]);</div><div class="line"></div><div class="line">x.invert(80); // 20</div><div class="line">x.invert(320); // 50</div></div><!-- fragment --><p>If the given <em>value</em> is outside the range, and <a href="#continuous_clamp">clamping</a> is not enabled, the mapping may be extrapolated such that the returned value is outside the domain. This method is only supported if the range is numeric. If the range is not numeric, returns NaN.</p>
<p>For a valid value <em>y</em> in the range, <em>continuous</em>(<em>continuous</em>.invert(<em>y</em>)) approximately equals <em>y</em>; similarly, for a valid value <em>x</em> in the domain, <em>continuous</em>.invert(<em>continuous</em>(<em>x</em>)) approximately equals <em>x</em>. The scale and its inverse may not be exact due to the limitations of floating point precision.</p>
<p><a class="anchor" id="continuous_domain"></a># <em>continuous</em>.<b>domain</b>([<em>domain</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/continuous.js#L92" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">var color = d3.scaleLinear()</div><div class="line">    .domain([-1, 0, 1])</div><div class="line">    .range([&quot;red&quot;, &quot;white&quot;, &quot;green&quot;]);</div><div class="line"></div><div class="line">color(-0.5); // &quot;rgb(255, 128, 128)&quot;</div><div class="line">color(+0.5); // &quot;rgb(128, 192, 128)&quot;</div></div><!-- fragment --><p>Internally, a piecewise scale performs a <a href="https://github.com/d3/d3-array#bisect">binary search</a> for the range interpolator corresponding to the given domain value. Thus, the domain must be in ascending or descending order. If the domain and range have different lengths <em>N</em> and <em>M</em>, only the first <em>min(N,M)</em> elements in each are observed.</p>
<p><a class="anchor" id="continuous_range"></a># <em>continuous</em>.<b>range</b>([<em>range</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/continuous.js#L96" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="continuous_rangeRound"></a># <em>continuous</em>.<b>rangeRound</b>([<em>range</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/continuous.js#L100" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">continuous</div><div class="line">    .range(range)</div><div class="line">    .interpolate(d3.interpolateRound);</div></div><!-- fragment --><p>The rounding interpolator is sometimes useful for avoiding antialiasing artifacts, though also consider the <a href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/shape-rendering">shape-rendering</a> “crispEdges” styles. Note that this interpolator can only be used with numeric ranges.</p>
<p><a class="anchor" id="continuous_clamp"></a># <em>continuous</em>.<b>clamp</b>(<em>clamp</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/continuous.js#L104" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">var x = d3.scaleLinear()</div><div class="line">    .domain([10, 130])</div><div class="line">    .range([0, 960]);</div><div class="line"></div><div class="line">x(-10); // -160, outside range</div><div class="line">x.invert(-160); // -10, outside domain</div><div class="line"></div><div class="line">x.clamp(true);</div><div class="line">x(-10); // 0, clamped to range</div><div class="line">x.invert(-160); // 10, clamped to domain</div></div><!-- fragment --><p>If <em>clamp</em> is not specified, returns whether or not the scale currently clamps values to within the range.</p>
<p><a class="anchor" id="continuous_interpolate"></a># <em>continuous</em>.<b>interpolate</b>(<em>interpolate</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/continuous.js#L108" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">var color = d3.scaleLinear()</div><div class="line">    .domain([-100, 0, +100])</div><div class="line">    .range([&quot;red&quot;, &quot;white&quot;, &quot;green&quot;]);</div></div><!-- fragment --><p>Two interpolators are created internally by the scale, equivalent to:</p>
<div class="fragment"><div class="line">var i0 = d3.interpolate(&quot;red&quot;, &quot;white&quot;),</div><div class="line">    i1 = d3.interpolate(&quot;white&quot;, &quot;green&quot;);</div></div><!-- fragment --><p>A common reason to specify a custom interpolator is to change the color space of interpolation. For example, to use <a href="https://github.com/d3/d3-interpolate#interpolateHcl">HCL</a>:</p>
<div class="fragment"><div class="line">var color = d3.scaleLinear()</div><div class="line">    .domain([10, 100])</div><div class="line">    .range([&quot;brown&quot;, &quot;steelblue&quot;])</div><div class="line">    .interpolate(d3.interpolateHcl);</div></div><!-- fragment --><p>Or for <a href="https://github.com/d3/d3-interpolate#interpolateCubehelix">Cubehelix</a> with a custom gamma:</p>
<div class="fragment"><div class="line">var color = d3.scaleLinear()</div><div class="line">    .domain([10, 100])</div><div class="line">    .range([&quot;brown&quot;, &quot;steelblue&quot;])</div><div class="line">    .interpolate(d3.interpolateCubehelix.gamma(3));</div></div><!-- fragment --><p>Note: the <a href="https://github.com/d3/d3-interpolate#interpolate">default interpolator</a> <b>may reuse return values</b>. For example, if the range values are objects, then the value interpolator always returns the same object, modifying it in-place. If the scale is used to set an attribute or style, this is typically acceptable (and desirable for performance); however, if you need to store the scale’s return value, you must specify your own interpolator or make a copy as appropriate.</p>
<p><a class="anchor" id="continuous_ticks"></a># <em>continuous</em>.<b>ticks</b>([<em>count</em>])</p>
...
<p><a class="anchor" id="continuous_tickFormat"></a># <em>continuous</em>.<b>tickFormat</b>([<em>count</em>[, <em>specifier</em>]]) <a href="https://github.com/d3/d3-scale/blob/master/src/tickFormat.js" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">var x = d3.scaleLinear()</div><div class="line">    .domain([-1, 1])</div><div class="line">    .range([0, 960]);</div><div class="line"></div><div class="line">var ticks = x.ticks(5),</div><div class="line">    tickFormat = x.tickFormat(5, &quot;+%&quot;);</div><div class="line"></div><div class="line">ticks.map(tickFormat); // [&quot;-100%&quot;, &quot;-50%&quot;, &quot;+0%&quot;, &quot;+50%&quot;, &quot;+100%&quot;]</div></div><!-- fragment --><p>If <em>specifier</em> uses the format type <code>s</code>, the scale will return a <a href="https://github.com/d3/d3-format#locale_formatPrefix">SI-prefix format</a> based on the largest value in the domain. If the <em>specifier</em> already specifies a precision, this method is equivalent to <a href="https://github.com/d3/d3-format#locale_format"><em>locale</em>.format</a>.</p>
<p><a class="anchor" id="continuous_nice"></a># <em>continuous</em>.<b>nice</b>([<em>count</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/nice.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="continuous_copy"></a># <em>continuous</em>.<b>copy</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/continuous.js#L59" title="Source">&lt;&gt;</a></p>
<p>Returns an exact copy of this scale. Changes to this scale will not affect the returned scale, and vice versa.</p>
<h4>Linear Scales</h4>
<p><a class="anchor" id="scaleLinear"></a># d3.<b>scaleLinear</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/linear.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="scalePow"></a># d3.<b>scalePow</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/pow.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="pow"></a># <em>pow</em>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/pow.js#L9" title="Source">&lt;&gt;</a></p>
<p>See <a href="#_continuous"><em>continuous</em></a>.</p>
<p><a class="anchor" id="pow_invert"></a># <em>pow</em>.<b>invert</b>(<em>value</em>)</p>
<p>See <a href="#continuous_invert"><em>continuous</em>.invert</a>.</p>
<p><a class="anchor" id="pow_exponent"></a># <em>pow</em>.<b>exponent</b>([<em>exponent</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/pow.js#L25" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="pow_domain"></a># <em>pow</em>.<b>domain</b>([<em>domain</em>])</p>
<p>See <a href="#continuous_domain"><em>continuous</em>.domain</a>.</p>
<p><a class="anchor" id="pow_range"></a># <em>pow</em>.<b>range</b>([<em>range</em>])</p>
<p>See <a href="#continuous_range"><em>continuous</em>.range</a>.</p>
<p><a class="anchor" id="pow_rangeRound"></a># <em>pow</em>.<b>rangeRound</b>([<em>range</em>])</p>
<p>See <a href="#continuous_rangeRound"><em>continuous</em>.rangeRound</a>.</p>
<p><a class="anchor" id="pow_clamp"></a># <em>pow</em>.<b>clamp</b>(<em>clamp</em>)</p>
<p>See <a href="#continuous_clamp"><em>continuous</em>.clamp</a>.</p>
<p><a class="anchor" id="pow_interpolate"></a># <em>pow</em>.<b>interpolate</b>(<em>interpolate</em>)</p>
<p>See <a href="#continuous_interpolate"><em>continuous</em>.interpolate</a>.</p>
<p><a class="anchor" id="pow_ticks"></a># <em>pow</em>.<b>ticks</b>([<em>count</em>])</p>
<p>See <a href="#continuous_ticks"><em>continuous</em>.ticks</a>.</p>
<p><a class="anchor" id="pow_tickFormat"></a># <em>pow</em>.<b>tickFormat</b>([<em>count</em>[, <em>specifier</em>]])</p>
<p>See <a href="#continuous_tickFormat"><em>continuous</em>.tickFormat</a>.</p>
<p><a class="anchor" id="pow_nice"></a># <em>pow</em>.<b>nice</b>([<em>count</em>])</p>
<p>See <a href="#continuous_nice"><em>continuous</em>.nice</a>.</p>
<p><a class="anchor" id="pow_copy"></a># <em>pow</em>.<b>copy</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/pow.js#L29" title="Source">&lt;&gt;</a></p>
<p>See <a href="#continuous_copy"><em>continuous</em>.copy</a>.</p>
<p><a class="anchor" id="scaleSqrt"></a># d3.<b>scaleSqrt</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/pow.js#L36" title="Source">&lt;&gt;</a></p>
...
<h4><a class="el" href="classLog.html">Log</a> Scales</h4>
<p><a class="el" href="classLog.html">Log</a> scales are similar to <a href="#linear-scales">linear scales</a>, except a logarithmic transform is applied to the input domain value before the output range value is computed. The mapping to the range value <em>y</em> can be expressed as a function of the domain value <em>x</em>: <em>y</em> = <em>m</em> log(<em>x</em>) + <em>b</em>.</p>
<p>As log(0) = -∞, a log scale domain must be <b>strictly-positive or strictly-negative</b>; the domain must not include or cross zero. A log scale with a positive domain has a well-defined behavior for positive values, and a log scale with a negative domain has a well-defined behavior for negative values. (For a negative domain, input and output values are implicitly multiplied by -1.) The behavior of the scale is undefined if you pass a negative value to a log scale with a positive domain or vice versa.</p>
<p><a class="anchor" id="scaleLog"></a># d3.<b>scaleLog</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/log.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="log"></a># <em>log</em>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/log.js#L42" title="Source">&lt;&gt;</a></p>
<p>See <a href="#_continuous"><em>continuous</em></a>.</p>
<p><a class="anchor" id="log_invert"></a># <em>log</em>.<b>invert</b>(<em>value</em>)</p>
<p>See <a href="#continuous_invert"><em>continuous</em>.invert</a>.</p>
<p><a class="anchor" id="log_base"></a># <em>log</em>.<b>base</b>([<em>base</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/log.js#L55" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="log_domain"></a># <em>log</em>.<b>domain</b>([<em>domain</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/log.js#L59" title="Source">&lt;&gt;</a></p>
<p>See <a href="#continuous_domain"><em>continuous</em>.domain</a>.</p>
<p><a class="anchor" id="log_range"></a># <em>log</em>.<b>range</b>([<em>range</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/continuous.js#L96" title="Source">&lt;&gt;</a></p>
<p>See <a href="#continuous_range"><em>continuous</em>.range</a>.</p>
<p><a class="anchor" id="log_rangeRound"></a># <em>log</em>.<b>rangeRound</b>([<em>range</em>])</p>
<p>See <a href="#continuous_rangeRound"><em>continuous</em>.rangeRound</a>.</p>
<p><a class="anchor" id="log_clamp"></a># <em>log</em>.<b>clamp</b>(<em>clamp</em>)</p>
<p>See <a href="#continuous_clamp"><em>continuous</em>.clamp</a>.</p>
<p><a class="anchor" id="log_interpolate"></a># <em>log</em>.<b>interpolate</b>(<em>interpolate</em>)</p>
<p>See <a href="#continuous_interpolate"><em>continuous</em>.interpolate</a>.</p>
<p><a class="anchor" id="log_ticks"></a># <em>log</em>.<b>ticks</b>([<em>count</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/log.js#L63" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="log_tickFormat"></a># <em>log</em>.<b>tickFormat</b>([<em>count</em>[, <em>specifier</em>]]) <a href="https://github.com/d3/d3-scale/blob/master/src/log.js#L103" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="log_nice"></a># <em>log</em>.<b>nice</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/log.js#L116" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="log_copy"></a># <em>log</em>.<b>copy</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/log.js#L123" title="Source">&lt;&gt;</a></p>
<p>See <a href="#continuous_copy"><em>continuous</em>.copy</a>.</p>
<h4>Identity Scales</h4>
...
<p><a class="anchor" id="scaleIdentity"></a># d3.<b>scaleIdentity</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/identity.js" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">var x = d3.scaleTime()</div><div class="line">    .domain([new Date(2000, 0, 1), new Date(2000, 0, 2)])</div><div class="line">    .range([0, 960]);</div><div class="line"></div><div class="line">x(new Date(2000, 0, 1,  5)); // 200</div><div class="line">x(new Date(2000, 0, 1, 16)); // 640</div><div class="line">x.invert(200); // Sat Jan 01 2000 05:00:00 GMT-0800 (PST)</div><div class="line">x.invert(640); // Sat Jan 01 2000 16:00:00 GMT-0800 (PST)</div></div><!-- fragment --><p>For a valid value <em>y</em> in the range, <em>time</em>(<em>time</em>.invert(<em>y</em>)) equals <em>y</em>; similarly, for a valid value <em>x</em> in the domain, <em>time</em>.invert(<em>time</em>(<em>x</em>)) equals <em>x</em>. The invert method is useful for interaction, say to determine the value in the domain that corresponds to the pixel location under the mouse.</p>
<p><a class="anchor" id="scaleTime"></a># d3.<b>scaleTime</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/time.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="time"></a># <em>time</em>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/time.js#L133" title="Source">&lt;&gt;</a></p>
<p>See <a href="#_continuous"><em>continuous</em></a>.</p>
<p><a class="anchor" id="time_invert"></a># <em>time</em>.<b>invert</b>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/time.js#L95" title="Source">&lt;&gt;</a></p>
<p>See <a href="#continuous_invert"><em>continuous</em>.invert</a>.</p>
<p><a class="anchor" id="time_domain"></a># <em>time</em>.<b>domain</b>([<em>domain</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/time.js#L99" title="Source">&lt;&gt;</a></p>
<p>See <a href="#continuous_domain"><em>continuous</em>.domain</a>.</p>
<p><a class="anchor" id="time_range"></a># <em>time</em>.<b>range</b>([<em>range</em>])</p>
<p>See <a href="#continuous_range"><em>continuous</em>.range</a>.</p>
<p><a class="anchor" id="time_rangeRound"></a># <em>time</em>.<b>rangeRound</b>([<em>range</em>])</p>
<p>See <a href="#continuous_rangeRound"><em>continuous</em>.rangeRound</a>.</p>
<p><a class="anchor" id="time_clamp"></a># <em>time</em>.<b>clamp</b>(<em>clamp</em>)</p>
<p>See <a href="#continuous_clamp"><em>continuous</em>.clamp</a>.</p>
<p><a class="anchor" id="time_interpolate"></a># <em>time</em>.<b>interpolate</b>(<em>interpolate</em>)</p>
<p>See <a href="#continuous_interpolate"><em>continuous</em>.interpolate</a>.</p>
<p><a class="anchor" id="time_ticks"></a># <em>time</em>.<b>ticks</b>([<em>count</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/time.js#L103" title="Source">&lt;&gt;</a> <br />
<a class="anchor" id="time_ticks"></a># <em>time</em>.<b>ticks</b>([<em>interval</em>])</p>
...
<div class="fragment"><div class="line">var x = d3.scaleTime();</div><div class="line"></div><div class="line">x.ticks(10);</div><div class="line">// [Sat Jan 01 2000 00:00:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 03:00:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 06:00:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 09:00:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 12:00:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 15:00:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 18:00:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 21:00:00 GMT-0800 (PST),</div><div class="line">//  Sun Jan 02 2000 00:00:00 GMT-0800 (PST)]</div></div><!-- fragment --><p>The following time intervals are considered for automatic ticks:</p>
<ul>
...
<div class="fragment"><div class="line">var x = d3.scaleTime()</div><div class="line">    .domain([new Date(2000, 0, 1, 0), new Date(2000, 0, 1, 2)]);</div><div class="line"></div><div class="line">x.ticks(d3.timeMinute.every(15));</div><div class="line">// [Sat Jan 01 2000 00:00:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 00:15:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 00:30:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 00:45:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 01:00:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 01:15:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 01:30:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 01:45:00 GMT-0800 (PST),</div><div class="line">//  Sat Jan 01 2000 02:00:00 GMT-0800 (PST)]</div></div><!-- fragment --><p>Alternatively, pass a test function to <a href="https://github.com/d3/d3-time#interval_filter"><em>interval</em>.filter</a>:</p>
<div class="fragment"><div class="line">x.ticks(d3.timeMinute.filter(function(d) {</div><div class="line">  return d.getMinutes() % 15 === 0;</div><div class="line">}));</div></div><!-- fragment --><p>Note: in some cases, such as with day ticks, specifying a <em>step</em> can result in irregular spacing of ticks because time intervals have varying length.</p>
<p><a class="anchor" id="time_tickFormat"></a># <em>time</em>.<b>tickFormat</b>([<em>count</em>[, <em>specifier</em>]]) <a href="https://github.com/d3/d3-scale/blob/master/src/time.js#L115" title="Source">&lt;&gt;</a> <br />
<a href="#time_tickFormat">#</a> <em>time</em>.<b>tickFormat</b>([<em>interval</em>[, <em>specifier</em>]])</p>
...
<p><a class="anchor" id="time_nice"></a># <em>time</em>.<b>nice</b>([<em>count</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/time.js#L119" title="Source">&lt;&gt;</a> <br />
<a class="anchor" id="time_nice"></a># <em>time</em>.<b>nice</b>([<em>interval</em>[, <em>step</em>]])</p>
...
<p><a class="anchor" id="scaleUtc"></a># d3.<b>scaleUtc</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/utcTime.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="scaleSequential"></a># d3.<b>scaleSequential</b>(<em>interpolator</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/sequential.js" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">var rainbow = d3.scaleSequential(function(t) {</div><div class="line">  return d3.hsl(t * 360, 1, 0.5) + &quot;&quot;;</div><div class="line">});</div></div><!-- fragment --><p>A more aesthetically-pleasing and perceptually-effective cyclical hue encoding is to use <a href="#interpolateRainbow">d3.interpolateRainbow</a>:</p>
<div class="fragment"><div class="line">var rainbow = d3.scaleSequential(d3.interpolateRainbow);</div></div><!-- fragment --><p>For even more sequential color schemes, see <a href="https://github.com/d3/d3-scale-chromatic">d3-scale-chromatic</a>.</p>
<p><a class="anchor" id="_sequential"></a># <em>sequential</em>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/sequential.js#L3" title="Source">&lt;&gt;</a></p>
<p>See <a href="#_continuous"><em>continuous</em></a>.</p>
<p><a class="anchor" id="sequential_domain"></a># <em>sequential</em>.<b>domain</b>([<em>domain</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/sequential.js#L13" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="sequential_clamp"></a># <em>sequential</em>.<b>clamp</b>([<em>clamp</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/sequential.js#L17" title="Source">&lt;&gt;</a></p>
<p>See <a href="#continuous_clamp"><em>continuous</em>.clamp</a>.</p>
<p><a class="anchor" id="sequential_interpolator"></a># <em>sequential</em>.<b>interpolator</b>([<em>interpolator</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/sequential.js#L21" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="sequential_copy"></a># <em>sequential</em>.<b>copy</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/sequential.js#L25" title="Source">&lt;&gt;</a></p>
<p>See <a href="#continuous_copy"><em>continuous</em>.copy</a>.</p>
<p><a class="anchor" id="interpolateViridis"></a># d3.<b>interpolateViridis</b>(<em>t</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/viridis.js" title="Source">&lt;&gt;</a></p>
<div class="image">
...
<p><a class="anchor" id="interpolateInferno"></a># d3.<b>interpolateInferno</b>(<em>t</em>)</p>
<div class="image">
...
<p><a class="anchor" id="interpolateMagma"></a># d3.<b>interpolateMagma</b>(<em>t</em>)</p>
<div class="image">
...
<p><a class="anchor" id="interpolatePlasma"></a># d3.<b>interpolatePlasma</b>(<em>t</em>)</p>
<div class="image">
...
<p><a class="anchor" id="interpolateWarm"></a># d3.<b>interpolateWarm</b>(<em>t</em>)</p>
<div class="image">
...
<p><a class="anchor" id="interpolateCool"></a># d3.<b>interpolateCool</b>(<em>t</em>)</p>
<div class="image">
...
<p><a class="anchor" id="interpolateRainbow"></a># d3.<b>interpolateRainbow</b>(<em>t</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/rainbow.js" title="Source">&lt;&gt;</a></p>
<div class="image">
...
<p><a class="anchor" id="interpolateCubehelixDefault"></a># d3.<b>interpolateCubehelixDefault</b>(<em>t</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/cubehelix.js" title="Source">&lt;&gt;</a></p>
<div class="image">
<img src="https://raw.githubusercontent.com/d3/d3-scale/master/img/cubehelix.png" width="100%" height="40" alt="cubehelix"/>
</div>
<p>Given a number <em>t</em> in the range [0,1], returns the corresponding color from <a href="https://www.mrao.cam.ac.uk/~dag/CUBEHELIX/">Green’s default Cubehelix</a> represented as an RGB string.</p>
<h3>Quantize Scales</h3>
...
<p><a class="anchor" id="scaleQuantize"></a># d3.<b>scaleQuantize</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/quantize.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="_quantize"></a># <em>quantize</em>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/quantize.js#L5" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">var color = d3.scaleQuantize()</div><div class="line">    .domain([0, 1])</div><div class="line">    .range([&quot;brown&quot;, &quot;steelblue&quot;]);</div><div class="line"></div><div class="line">color(0.49); // &quot;brown&quot;</div><div class="line">color(0.51); // &quot;steelblue&quot;</div></div><!-- fragment --><p>Or dividing the domain into three equally-sized parts with different range values to compute an appropriate stroke width:</p>
<div class="fragment"><div class="line">var width = d3.scaleQuantize()</div><div class="line">    .domain([10, 100])</div><div class="line">    .range([1, 2, 4]);</div><div class="line"></div><div class="line">width(20); // 1</div><div class="line">width(50); // 2</div><div class="line">width(80); // 4</div></div><!-- fragment --><p><a class="anchor" id="quantize_invertExtent"></a># <em>quantize</em>.<b>invertExtent</b>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/quantize.js#L31" title="Source">&lt;&gt;</a></p>
<p>Returns the extent of values in the <a href="#quantize_domain">domain</a> [<em>x0</em>, <em>x1</em>] for the corresponding <em>value</em> in the <a href="#quantize_range">range</a>: the inverse of <a href="#_quantize"><em>quantize</em></a>. This method is useful for interaction, say to determine the value in the domain that corresponds to the pixel location under the mouse.</p>
<div class="fragment"><div class="line">var width = d3.scaleQuantize()</div><div class="line">    .domain([10, 100])</div><div class="line">    .range([1, 2, 4]);</div><div class="line"></div><div class="line">width.invertExtent(2); // [40, 70]</div></div><!-- fragment --><p><a class="anchor" id="quantize_domain"></a># <em>quantize</em>.<b>domain</b>([<em>domain</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/quantize.js#L23" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="quantize_range"></a># <em>quantize</em>.<b>range</b>([<em>range</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/quantize.js#L27" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="quantize_ticks"></a># <em>quantize</em>.<b>ticks</b>([<em>count</em>])</p>
<p>Equivalent to <a href="#continuous_ticks"><em>continuous</em>.ticks</a>.</p>
<p><a class="anchor" id="quantize_tickFormat"></a># <em>quantize</em>.<b>tickFormat</b>([<em>count</em>[, <em>specifier</em>]]) <a href="https://github.com/d3/d3-scale/blob/master/src/linear.js#L14" title="Source">&lt;&gt;</a></p>
<p>Equivalent to <a href="#continuous_tickFormat"><em>continuous</em>.tickFormat</a>.</p>
<p><a class="anchor" id="quantize_nice"></a># <em>quantize</em>.<b>nice</b>()</p>
<p>Equivalent to <a href="#continuous_nice"><em>continuous</em>.nice</a>.</p>
<p><a class="anchor" id="quantize_copy"></a># <em>quantize</em>.<b>copy</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/quantize.js#L39" title="Source">&lt;&gt;</a></p>
<p>Returns an exact copy of this scale. Changes to this scale will not affect the returned scale, and vice versa.</p>
<h3>Quantile Scales</h3>
...
<p><a class="anchor" id="scaleQuantile"></a># d3.<b>scaleQuantile</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/quantile.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="_quantile"></a># <em>quantile</em>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/quantile.js#L4" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="quantile_invertExtent"></a># <em>quantile</em>.<b>invertExtent</b>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/quantile.js#L20" title="Source">&lt;&gt;</a></p>
<p>Returns the extent of values in the <a href="#quantile_domain">domain</a> [<em>x0</em>, <em>x1</em>] for the corresponding <em>value</em> in the <a href="#quantile_range">range</a>: the inverse of <a href="#_quantile"><em>quantile</em></a>. This method is useful for interaction, say to determine the value in the domain that corresponds to the pixel location under the mouse.</p>
<p><a class="anchor" id="quantile_domain"></a># <em>quantile</em>.<b>domain</b>([<em>domain</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/quantile.js#L28" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="quantile_range"></a># <em>quantile</em>.<b>range</b>([<em>range</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/quantile.js#L36" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="quantile_quantiles"></a># <em>quantile</em>.<b>quantiles</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/quantile.js#L40" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="quantile_copy"></a># <em>quantile</em>.<b>copy</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/quantile.js#L44" title="Source">&lt;&gt;</a></p>
<p>Returns an exact copy of this scale. Changes to this scale will not affect the returned scale, and vice versa.</p>
<h3>Threshold Scales</h3>
...
<p><a class="anchor" id="scaleThreshold"></a># d3.<b>scaleThreshold</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/threshold.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="_threshold"></a># <em>threshold</em>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/threshold.js#L4" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">var color = d3.scaleThreshold()</div><div class="line">    .domain([0, 1])</div><div class="line">    .range([&quot;red&quot;, &quot;white&quot;, &quot;green&quot;]);</div><div class="line"></div><div class="line">color(-1);   // &quot;red&quot;</div><div class="line">color(0);    // &quot;white&quot;</div><div class="line">color(0.5);  // &quot;white&quot;</div><div class="line">color(1);    // &quot;green&quot;</div><div class="line">color(1000); // &quot;green&quot;</div></div><!-- fragment --><p><a class="anchor" id="threshold_invertExtent"></a># <em>threshold</em>.<b>invertExtent</b>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/threshold.js#L21" title="Source">&lt;&gt;</a></p>
<p>Returns the extent of values in the <a href="#threshold_domain">domain</a> [<em>x0</em>, <em>x1</em>] for the corresponding <em>value</em> in the <a href="#threshold_range">range</a>, representing the inverse mapping from range to domain. This method is useful for interaction, say to determine the value in the domain that corresponds to the pixel location under the mouse. For example:</p>
<div class="fragment"><div class="line">var color = d3.scaleThreshold()</div><div class="line">    .domain([0, 1])</div><div class="line">    .range([&quot;red&quot;, &quot;white&quot;, &quot;green&quot;]);</div><div class="line"></div><div class="line">color.invertExtent(&quot;red&quot;); // [undefined, 0]</div><div class="line">color.invertExtent(&quot;white&quot;); // [0, 1]</div><div class="line">color.invertExtent(&quot;green&quot;); // [1, undefined]</div></div><!-- fragment --><p><a class="anchor" id="threshold_domain"></a># <em>threshold</em>.<b>domain</b>([<em>domain</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/threshold.js#L13" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="threshold_range"></a># <em>threshold</em>.<b>range</b>([<em>range</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/threshold.js#L17" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="threshold_copy"></a># <em>threshold</em>.<b>copy</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/threshold.js#L26" title="Source">&lt;&gt;</a></p>
<p>Returns an exact copy of this scale. Changes to this scale will not affect the returned scale, and vice versa.</p>
...
<p><a class="anchor" id="scaleOrdinal"></a># d3.<b>scaleOrdinal</b>([<em>range</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/ordinal.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="_ordinal"></a># <em>ordinal</em>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/ordinal.js#L6" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="ordinal_domain"></a># <em>ordinal</em>.<b>domain</b>([<em>domain</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/ordinal.js#L22" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="ordinal_range"></a># <em>ordinal</em>.<b>range</b>([<em>range</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/ordinal.js#L30" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="ordinal_unknown"></a># <em>ordinal</em>.<b>unknown</b>([<em>value</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/ordinal.js#L34" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="ordinal_copy"></a># <em>ordinal</em>.<b>copy</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/ordinal.js#L38" title="Source">&lt;&gt;</a></p>
<p>Returns an exact copy of this ordinal scale. Changes to this scale will not affect the returned scale, and vice versa.</p>
<p><a class="anchor" id="scaleImplicit"></a># d3.<b>scaleImplicit</b></p>
...
<p><a class="anchor" id="scaleBand"></a># d3.<b>scaleBand</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/band.js" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="_band"></a># <em>band</em>(<em>value</em>) <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L4" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="band_domain"></a># <em>band</em>.<b>domain</b>([<em>domain</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L32" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="band_range"></a># <em>band</em>.<b>range</b>([<em>range</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L36" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="band_rangeRound"></a># <em>band</em>.<b>rangeRound</b>([<em>range</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L40" title="Source">&lt;&gt;</a></p>
...
<div class="fragment"><div class="line">band</div><div class="line">    .range(range)</div><div class="line">    .round(true);</div></div><!-- fragment --><p>Rounding is sometimes useful for avoiding antialiasing artifacts, though also consider the <a href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/shape-rendering">shape-rendering</a> “crispEdges” styles.</p>
<p><a class="anchor" id="band_round"></a># <em>band</em>.<b>round</b>([<em>round</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L52" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="band_paddingInner"></a># <em>band</em>.<b>paddingInner</b>([<em>padding</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L60" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="band_paddingOuter"></a># <em>band</em>.<b>paddingOuter</b>([<em>padding</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L64" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="band_padding"></a># <em>band</em>.<b>padding</b>([<em>padding</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L56" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="band_align"></a># <em>band</em>.<b>align</b>([<em>align</em>]) <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L68" title="Source">&lt;&gt;</a></p>
...
<p><a class="anchor" id="band_bandwidth"></a># <em>band</em>.<b>bandwidth</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L44" title="Source">&lt;&gt;</a></p>
<p>Returns the width of each band.</p>
<p><a class="anchor" id="band_step"></a># <em>band</em>.<b>step</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L48" title="Source">&lt;&gt;</a></p>
<p>Returns the distance between the starts of adjacent bands.</p>
<p><a class="anchor" id="band_copy"></a># <em>band</em>.<b>copy</b>() <a href="https://github.com/d3/d3-scale/blob/master/src/band.js#L72" title="Source">&lt;&gt;</a></p>
<p>Returns an exact copy of this scale. Changes to this scale will not affect the returned scale, and vice versa.</p>
<h4>Point Scales</h4>
...
<p><a class="anchor" id="scalePoint"></a># d3.<b>scalePoint</b>()</p>
...
<p><a class="anchor" id="_point"></a># <em>point</em>(<em>value</em>)</p>
...
<p><a class="anchor" id="point_domain"></a># <em>point</em>.<b>domain</b>([<em>domain</em>])</p>
...
<p><a class="anchor" id="point_range"></a># <em>point</em>.<b>range</b>([<em>range</em>])</p>
<p>If <em>range</em> is specified, sets the scale’s range to the specified two-element array of numbers. If the elements in the given array are not numbers, they will be coerced to numbers. If <em>range</em> is not specified, returns the scale’s current range, which defaults to [0, 1].</p>
<p><a class="anchor" id="point_rangeRound"></a># <em>point</em>.<b>rangeRound</b>([<em>range</em>])</p>
...
<div class="fragment"><div class="line">point</div><div class="line">    .range(range)</div><div class="line">    .round(true);</div></div><!-- fragment --><p>Rounding is sometimes useful for avoiding antialiasing artifacts, though also consider the <a href="https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/shape-rendering">shape-rendering</a> “crispEdges” styles.</p>
<p><a class="anchor" id="point_round"></a># <em>point</em>.<b>round</b>([<em>round</em>])</p>
...
<p><a class="anchor" id="point_padding"></a># <em>point</em>.<b>padding</b>([<em>padding</em>])</p>
...
<p><a class="anchor" id="point_align"></a># <em>point</em>.<b>align</b>([<em>align</em>])</p>
...
<p><a class="anchor" id="point_bandwidth"></a># <em>point</em>.<b>bandwidth</b>()</p>
<p>Returns zero.</p>
<p><a class="anchor" id="point_step"></a># <em>point</em>.<b>step</b>()</p>
<p>Returns the distance between the starts of adjacent points.</p>
<p><a class="anchor" id="point_copy"></a># <em>point</em>.<b>copy</b>()</p>
<p>Returns an exact copy of this scale. Changes to this scale will not affect the returned scale, and vice versa.</p>
<h4>Category Scales</h4>
<p>These color schemes are designed to work with <a href="#scaleOrdinal">d3.scaleOrdinal</a>. For example:</p>
<div class="fragment"><div class="line">var color = d3.scaleOrdinal(d3.schemeCategory10);</div></div><!-- fragment --><p>For even more category scales, see <a href="https://github.com/d3/d3-scale-chromatic">d3-scale-chromatic</a>.</p>
<p><a class="anchor" id="schemeCategory10"></a># d3.<b>schemeCategory10</b> <a href="https://github.com/d3/d3-scale/blob/master/src/category10.js" title="Source">&lt;&gt;</a></p>
<div class="image">
...
<p><a class="anchor" id="schemeCategory20"></a># d3.<b>schemeCategory20</b> <a href="https://github.com/d3/d3-scale/blob/master/src/category20.js" title="Source">&lt;&gt;</a></p>
<div class="image">
...
<p><a class="anchor" id="schemeCategory20b"></a># d3.<b>schemeCategory20b</b> <a href="https://github.com/d3/d3-scale/blob/master/src/category20b.js" title="Source">&lt;&gt;</a></p>
<div class="image">
<img src="https://raw.githubusercontent.com/d3/d3-scale/master/img/category20b.png" width="100%" height="40" alt="category20b"/>
</div>
<p>An array of twenty categorical colors represented as RGB hexadecimal strings.</p>
<p><a class="anchor" id="schemeCategory20c"></a># d3.<b>schemeCategory20c</b> <a href="https://github.com/d3/d3-scale/blob/master/src/category20c.js" title="Source">&lt;&gt;</a></p>
<div class="image">
