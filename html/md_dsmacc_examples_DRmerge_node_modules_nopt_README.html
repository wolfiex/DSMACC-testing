...
<div class="fragment"><div class="line">$ node my-program.js --foo &quot;blerp&quot; --no-flag</div><div class="line">{ &quot;foo&quot; : &quot;blerp&quot;, &quot;flag&quot; : false }</div><div class="line"></div><div class="line">$ node my-program.js ---bar 7 --foo &quot;Mr. Hand&quot; --flag</div><div class="line">{ bar: 7, foo: &quot;Mr. Hand&quot;, flag: true }</div><div class="line"></div><div class="line">$ node my-program.js --foo &quot;blerp&quot; -f -----p</div><div class="line">{ foo: &quot;blerp&quot;, flag: true, pick: true }</div><div class="line"></div><div class="line">$ node my-program.js -fp --foofoo</div><div class="line">{ foo: &quot;Mr. Foo&quot;, flag: true, pick: true }</div><div class="line"></div><div class="line">$ node my-program.js --foofoo -- -fp  # -- stops the flag parsing.</div><div class="line">{ foo: &quot;Mr. Foo&quot;, argv: { remain: [&quot;-fp&quot;] } }</div><div class="line"></div><div class="line">$ node my-program.js --blatzk -fp # unknown opts are ok.</div><div class="line">{ blatzk: true, flag: true, pick: true }</div><div class="line"></div><div class="line">$ node my-program.js --blatzk=1000 -fp # but you need to use = if they have a value</div><div class="line">{ blatzk: 1000, flag: true, pick: true }</div><div class="line"></div><div class="line">$ node my-program.js --no-blatzk -fp # unless they start with &quot;no-&quot;</div><div class="line">{ blatzk: false, flag: true, pick: true }</div><div class="line"></div><div class="line">$ node my-program.js --baz b/a/z # known paths are resolved.</div><div class="line">{ baz: &quot;/Users/isaacs/b/a/z&quot; }</div><div class="line"></div><div class="line"># if Array is one of the types, then it can take many</div><div class="line"># values, and will always be an array.  The other types provided</div><div class="line"># specify what types are allowed in the list.</div><div class="line"></div><div class="line">$ node my-program.js --many1 5 --many1 null --many1 foo</div><div class="line">{ many1: [&quot;5&quot;, &quot;null&quot;, &quot;foo&quot;] }</div><div class="line"></div><div class="line">$ node my-program.js --many2 foo --many2 bar</div><div class="line">{ many2: [&quot;/path/to/foo&quot;, &quot;path/to/bar&quot;] }</div></div><!-- fragment --><p>Read the tests at the bottom of <code>lib/nopt.js</code> for more examples of what this puppy can do.</p>
<h2>Types</h2>
...
<li><a class="el" href="classDate.html">Date</a>: Must parse as a date. If it does, and <code><a class="el" href="classDate.html">Date</a></code> is one of the options, then it will return a <a class="el" href="classDate.html">Date</a> object, not a string.</li>
...
<h2>Slicing</h2>
<p><a class="el" href="classNode.html">Node</a> programs are called with more or less the exact argv as it appears in C land, after the v8 and node-specific options have been plucked off. As such, <code>argv[0]</code> is always <code>node</code> and <code>argv[1]</code> is always the JavaScript program being run.</p>
