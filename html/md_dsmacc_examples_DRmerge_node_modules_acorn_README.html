...
<div class="fragment"><div class="line">npm install acorn</div></div><!-- fragment --><p>Alternately, you can download the source and build acorn yourself:</p>
...
<div class="fragment"><div class="line">var acorn = require(&quot;acorn&quot;);</div><div class="line">var jsx = require(&quot;acorn-jsx&quot;);</div><div class="line">var JSXParser = acorn.Parser.extend(jsx());</div><div class="line">JSXParser.parse(&quot;foo(&lt;bar/&gt;)&quot;);</div></div><!-- fragment --><p>The <code>extend</code> method takes any number of plugin values, and returns a new <code>Parser</code> class that includes the extra parser logic provided by the plugins.</p>
