...
<p><a href="https://travis-ci.org/epoberezkin/ajv"></a> <a href="https://www.npmjs.com/package/ajv"></a> <a href="https://www.npmjs.com/package/ajv"></a> <a href="https://coveralls.io/github/epoberezkin/ajv?branch=master"></a> <a href="https://greenkeeper.io/"></a> <a href="https://gitter.im/ajv-validator/ajv"></a></p>
<h3>_Ajv and <a href="#related-packages">related repositories</a> will be transfered to <a href="https://github.com/ajv-validator">ajv-validator</a> org_</h3>
...
<div class="fragment"><div class="line">ajv.addMetaSchema(require(&#39;ajv/lib/refs/json-schema-draft-06.json&#39;));</div></div><!-- fragment --><p>To use Ajv with draft-04 schemas in addition to explicitly adding meta-schema you also need to use option schemaId:</p>
<div class="fragment"><div class="line">var ajv = new Ajv({schemaId: &#39;id&#39;});</div><div class="line">// If you want to use both draft-04 and draft-06/07 schemas:</div><div class="line">// var ajv = new Ajv({schemaId: &#39;auto&#39;});</div><div class="line">ajv.addMetaSchema(require(&#39;ajv/lib/refs/json-schema-draft-04.json&#39;));</div></div><!-- fragment --><h2>Contents</h2>
<ul>
...
<div class="fragment"><div class="line">// ...</div><div class="line">var valid = ajv.addSchema(schema, &#39;mySchema&#39;)</div><div class="line">               .validate(&#39;mySchema&#39;, data);</div><div class="line">if (!valid) console.log(ajv.errorsText());</div><div class="line">// ...</div></div><!-- fragment --><p>See <a href="#api">API</a> and <a href="#options">Options</a> for more details.</p>
...
<p>Then you need to load Ajv in the browser: </p><div class="fragment"><div class="line">&lt;script src=&quot;ajv.min.js&quot;&gt;&lt;/script&gt;</div></div><!-- fragment --><p>This bundle can be used with different module systems; it creates global <code>Ajv</code> if no module system is found.</p>
...
<h2><a class="anchor" id="ref"></a>Combining schemas with $ref</h2>
...
<p>Example:</p>
<div class="fragment"><div class="line">var schema = {</div><div class="line">  &quot;$id&quot;: &quot;http://example.com/schemas/schema.json&quot;,</div><div class="line">  &quot;type&quot;: &quot;object&quot;,</div><div class="line">  &quot;properties&quot;: {</div><div class="line">    &quot;foo&quot;: { &quot;$ref&quot;: &quot;defs.json#/definitions/int&quot; },</div><div class="line">    &quot;bar&quot;: { &quot;$ref&quot;: &quot;defs.json#/definitions/str&quot; }</div><div class="line">  }</div><div class="line">};</div><div class="line"></div><div class="line">var defsSchema = {</div><div class="line">  &quot;$id&quot;: &quot;http://example.com/schemas/defs.json&quot;,</div><div class="line">  &quot;definitions&quot;: {</div><div class="line">    &quot;int&quot;: { &quot;type&quot;: &quot;integer&quot; },</div><div class="line">    &quot;str&quot;: { &quot;type&quot;: &quot;string&quot; }</div><div class="line">  }</div><div class="line">};</div></div><!-- fragment --><p>Now to compile your schema you can either pass all schemas to Ajv instance:</p>
<div class="fragment"><div class="line">var ajv = new Ajv({schemas: [schema, defsSchema]});</div><div class="line">var validate = ajv.getSchema(&#39;http://example.com/schemas/schema.json&#39;);</div></div><!-- fragment --><p>or use <code>addSchema</code> method:</p>
<div class="fragment"><div class="line">var ajv = new Ajv;</div><div class="line">var validate = ajv.addSchema(defsSchema)</div><div class="line">                  .compile(schema);</div></div><!-- fragment --><p>See <a href="#options">Options</a> and <a href="#api">addSchema</a> method.</p>
...
<div class="fragment"><div class="line">var ajv = new Ajv({$data: true});</div><div class="line"></div><div class="line">var schema = {</div><div class="line">  &quot;properties&quot;: {</div><div class="line">    &quot;smaller&quot;: {</div><div class="line">      &quot;type&quot;: &quot;number&quot;,</div><div class="line">      &quot;maximum&quot;: { &quot;$data&quot;: &quot;1/larger&quot; }</div><div class="line">    },</div><div class="line">    &quot;larger&quot;: { &quot;type&quot;: &quot;number&quot; }</div><div class="line">  }</div><div class="line">};</div><div class="line"></div><div class="line">var validData = {</div><div class="line">  smaller: 5,</div><div class="line">  larger: 7</div><div class="line">};</div><div class="line"></div><div class="line">ajv.validate(schema, validData); // true</div></div><!-- fragment --><p>This schema requires that the properties have the same format as their field names:</p>
...
<div class="fragment"><div class="line">ajv.addKeyword(&#39;range&#39;, {</div><div class="line">  type: &#39;number&#39;,</div><div class="line">  compile: function (sch, parentSchema) {</div><div class="line">    var min = sch[0];</div><div class="line">    var max = sch[1];</div><div class="line"></div><div class="line">    return parentSchema.exclusiveRange === true</div><div class="line">            ? function (data) { return data &gt; min &amp;&amp; data &lt; max; }</div><div class="line">            : function (data) { return data &gt;= min &amp;&amp; data &lt;= max; }</div><div class="line">  }</div><div class="line">});</div><div class="line"></div><div class="line">var schema = { &quot;range&quot;: [2, 4], &quot;exclusiveRange&quot;: true };</div><div class="line">var validate = ajv.compile(schema);</div><div class="line">console.log(validate(2.01)); // true</div><div class="line">console.log(validate(3.99)); // true</div><div class="line">console.log(validate(2)); // false</div><div class="line">console.log(validate(4)); // false</div></div><!-- fragment --><p>Several custom keywords (typeof, instanceof, range and propertyNames) are defined in <a href="https://github.com/epoberezkin/ajv-keywords">ajv-keywords</a> package - they can be used for your schemas and as a starting point for your own custom keywords.</p>
...
<h4>Using nodent</h4>
<div class="fragment"><div class="line">var ajv = new Ajv;</div><div class="line">require(&#39;ajv-async&#39;)(ajv);</div><div class="line">// in the browser if you want to load ajv-async bundle separately you can:</div><div class="line">// window.ajvAsync(ajv);</div><div class="line">var validate = ajv.compile(schema); // transpiled es7 async function</div><div class="line">validate(data).then(successFunc).catch(errorFunc);</div></div><!-- fragment --><h4>Using other transpilers</h4>
<div class="fragment"><div class="line">var ajv = new Ajv({ processCode: transpileFunc });</div><div class="line">var validate = ajv.compile(schema); // transpiled es7 async function</div><div class="line">validate(data).then(successFunc).catch(errorFunc);</div></div><!-- fragment --><p>See <a href="#options">Options</a>.</p>
...
<div class="fragment"><div class="line">const isSchemaSecure = ajv.compile(require(&#39;ajv/lib/refs/json-schema-secure.json&#39;));</div><div class="line"></div><div class="line">const schema1 = {format: &#39;email&#39;};</div><div class="line">isSchemaSecure(schema1); // false</div><div class="line"></div><div class="line">const schema2 = {format: &#39;email&#39;, maxLength: 256};</div><div class="line">isSchemaSecure(schema2); // true</div></div><!-- fragment --><p><b>Please note</b>: following all these recommendation is not a guarantee that validation of untrusted data is safe - it can still lead to some undesirable results.</p>
...
<div class="fragment"><div class="line">var validate = new Ajv().addSchema(schema).addFormat(name, regex).getSchema(uri);</div></div><!-- fragment --><h5>.addMetaSchema(Array&lt;Object&gt;|Object schema [, String key]) -&gt; Ajv</h5>
...
<h5><a class="anchor" id="api-addformat"></a>.addFormat(String name, String|RegExp|Function|Object format) -&gt; Ajv</h5>
...
<h5><a class="anchor" id="api-addkeyword"></a>.addKeyword(String keyword, Object definition) -&gt; Ajv</h5>
...
<h2>Options</h2>
<p>Defaults:</p>
<div class="fragment"><div class="line">{</div><div class="line">  // validation and reporting options:</div><div class="line">  $data:            false,</div><div class="line">  allErrors:        false,</div><div class="line">  verbose:          false,</div><div class="line">  $comment:         false, // NEW in Ajv version 6.0</div><div class="line">  jsonPointers:     false,</div><div class="line">  uniqueItems:      true,</div><div class="line">  unicode:          true,</div><div class="line">  nullable:         false,</div><div class="line">  format:           &#39;fast&#39;,</div><div class="line">  formats:          {},</div><div class="line">  unknownFormats:   true,</div><div class="line">  schemas:          {},</div><div class="line">  logger:           undefined,</div><div class="line">  // referenced schema options:</div><div class="line">  schemaId:         &#39;$id&#39;,</div><div class="line">  missingRefs:      true,</div><div class="line">  extendRefs:       &#39;ignore&#39;, // recommended &#39;fail&#39;</div><div class="line">  loadSchema:       undefined, // function(uri: string): Promise {}</div><div class="line">  // options to modify validated data:</div><div class="line">  removeAdditional: false,</div><div class="line">  useDefaults:      false,</div><div class="line">  coerceTypes:      false,</div><div class="line">  // strict mode options</div><div class="line">  strictDefaults:   false,</div><div class="line">  strictKeywords:   false,</div><div class="line">  // asynchronous validation options:</div><div class="line">  transpile:        undefined, // requires ajv-async package</div><div class="line">  // advanced options:</div><div class="line">  meta:             true,</div><div class="line">  validateSchema:   true,</div><div class="line">  addUsedSchema:    true,</div><div class="line">  inlineRefs:       true,</div><div class="line">  passContext:      false,</div><div class="line">  loopRequired:     Infinity,</div><div class="line">  ownProperties:    false,</div><div class="line">  multipleOfPrecision: false,</div><div class="line">  errorDataPath:    &#39;object&#39;, // deprecated</div><div class="line">  messages:         true,</div><div class="line">  sourceCode:       false,</div><div class="line">  processCode:      undefined, // function (str: string): string {}</div><div class="line">  cache:            new Cache,</div><div class="line">  serialize:        undefined</div><div class="line">}</div></div><!-- fragment --><h5>Validation and reporting options</h5>
<ul>
...
<li><em>$comment</em> (NEW in Ajv version 6.0): log or pass the value of <code>$comment</code> keyword to a function. <a class="el" href="structOption.html">Option</a> values:<ul>
...
<li><em>format</em>: formats validation mode. <a class="el" href="structOption.html">Option</a> values:<ul>
...
<li><em>unknownFormats</em>: handling of unknown formats. <a class="el" href="structOption.html">Option</a> values:<ul>
...
<li><em>logger</em>: sets the logging method. Default is the global <code>console</code> object that should have methods <code>log</code>, <code>warn</code> and <code>error</code>. <a class="el" href="structOption.html">Option</a> values:<ul>
...
<ul>
<li><em>schemaId</em>: this option defines which keywords are used as schema URI. <a class="el" href="structOption.html">Option</a> value:<ul>
...
<li><em>missingRefs</em>: handling of missing referenced schemas. <a class="el" href="structOption.html">Option</a> values:<ul>
...
<li><em>extendRefs</em>: validation of other keywords when <code>$ref</code> is present in the schema. <a class="el" href="structOption.html">Option</a> values:<ul>
...
<ul>
<li><em>removeAdditional</em>: remove additional properties - see example in <a href="#filtering-data">Filtering data</a>. This option is not used if schema is added with <code>addMetaSchema</code> method. <a class="el" href="structOption.html">Option</a> values:<ul>
...
<li><em>coerceTypes</em>: change data type of data to match <code>type</code> keyword. See the example in <a href="#coercing-data-types">Coercing data types</a> and https://github.com/epoberezkin/ajv/blob/master/COERCION.md "coercion rules". <a class="el" href="structOption.html">Option</a> values:<ul>
...
<ul>
<li><em>strictDefaults</em>: report ignored <code>default</code> keywords in schemas. <a class="el" href="structOption.html">Option</a> values:<ul>
...
<li><em>strictKeywords</em>: report unknown keywords in schemas. <a class="el" href="structOption.html">Option</a> values:<ul>
...
<ul>
<li><em>transpile</em>: Requires <a href="https://github.com/epoberezkin/ajv-async">ajv-async</a> package. It determines whether Ajv transpiles compiled asynchronous validation function. <a class="el" href="structOption.html">Option</a> values:<ul>
...
<li><em>inlineRefs</em>: Affects compilation of referenced schemas. <a class="el" href="structOption.html">Option</a> values:<ul>
