...
<title>DSMACC: electron-osx-sign [![npm][npm_img]][npm_url] [![Build Status][travis_img]][travis_url]</title>
...
<div class="title">electron-osx-sign [![npm][npm_img]][npm_url] [![Build Status][travis_img]][travis_url] </div>  </div>
</div><!--header-->
<div class="contents">
...
<p><code>hardedRuntime</code> - <em>Boolean</em></p>
...
<h2>Test</h2>
<p>As developer certificates are required for <code>codesign</code> on macOS, this module is difficult to be tested via online build services. If you wish to test out this module, enter:</p>
<div class="fragment"><div class="line">npm test</div></div><!-- fragment --><p>from the dev directory, and tell us if all tests should pass.</p>
<p>When this command is fun for the first time: <code>electron-download</code> will download all major releases of Electron available for macOS from 0.24.0, and save to <code>~/.electron/</code>, which might take up less than 1GB of disk space.</p>
<p>A successful testing should look something like:</p>
<div class="fragment"><div class="line">$ npm test</div><div class="line"></div><div class="line">&gt; electron-osx-sign@0.4.11 pretest electron-osx-sign</div><div class="line">&gt; rimraf test/work</div><div class="line"></div><div class="line">&gt; electron-osx-sign@0.4.11 test electron-osx-sign</div><div class="line">&gt; standard &amp;&amp; tape test</div><div class="line"></div><div class="line">Calling electron-download before running tests...</div><div class="line">Running tests...</div><div class="line">TAP version 13</div><div class="line"># setup</div><div class="line"># defaults-test:v0.29.2-darwin-x64</div><div class="line">ok 1 app signed</div><div class="line"># defaults-test:v0.30.8-darwin-x64</div><div class="line">ok 2 app signed</div><div class="line"># defaults-test:v0.31.2-darwin-x64</div><div class="line">ok 3 app signed</div><div class="line"># defaults-test:v0.32.3-darwin-x64</div><div class="line">ok 4 app signed</div><div class="line"># defaults-test:v0.33.9-darwin-x64</div><div class="line">ok 5 app signed</div><div class="line"># defaults-test:v0.34.5-darwin-x64</div><div class="line">ok 6 app signed</div><div class="line"># defaults-test:v0.34.5-mas-x64</div><div class="line">ok 7 app signed</div><div class="line"># defaults-test:v0.35.6-darwin-x64</div><div class="line">ok 8 app signed</div><div class="line"># defaults-test:v0.35.6-mas-x64</div><div class="line">ok 9 app signed</div><div class="line"># defaults-test:v0.36.12-darwin-x64</div><div class="line">ok 10 app signed</div><div class="line"># defaults-test:v0.36.12-mas-x64</div><div class="line">ok 11 app signed</div><div class="line"># defaults-test:v0.37.8-darwin-x64</div><div class="line">ok 12 app signed</div><div class="line"># defaults-test:v0.37.8-mas-x64</div><div class="line">ok 13 app signed</div><div class="line"># defaults-test:v1.0.2-darwin-x64</div><div class="line">ok 14 app signed</div><div class="line"># defaults-test:v1.0.2-mas-x64</div><div class="line">ok 15 app signed</div><div class="line"># defaults-test:v1.1.3-darwin-x64</div><div class="line">ok 16 app signed</div><div class="line"># defaults-test:v1.1.3-mas-x64</div><div class="line">ok 17 app signed</div><div class="line"># defaults-test:v1.2.8-darwin-x64</div><div class="line">ok 18 app signed</div><div class="line"># defaults-test:v1.2.8-mas-x64</div><div class="line">ok 19 app signed</div><div class="line"># defaults-test:v1.3.7-darwin-x64</div><div class="line">ok 20 app signed</div><div class="line"># defaults-test:v1.3.7-mas-x64</div><div class="line">ok 21 app signed</div><div class="line"># defaults-test:v1.4.15-darwin-x64</div><div class="line">ok 22 app signed</div><div class="line"># defaults-test:v1.4.15-mas-x64</div><div class="line">ok 23 app signed</div><div class="line"># defaults-test:v1.6.17-darwin-x64</div><div class="line">ok 24 app signed</div><div class="line"># defaults-test:v1.6.17-mas-x64</div><div class="line">ok 25 app signed</div><div class="line"># defaults-test:v1.7.12-darwin-x64</div><div class="line">ok 26 app signed</div><div class="line"># defaults-test:v1.7.12-mas-x64</div><div class="line">ok 27 app signed</div><div class="line"># defaults-test:v1.8.3-darwin-x64</div><div class="line">ok 28 app signed</div><div class="line"># defaults-test:v1.8.3-mas-x64</div><div class="line">ok 29 app signed</div><div class="line"># teardown</div><div class="line"></div><div class="line">1..29</div><div class="line"># tests 29</div><div class="line"># pass  29</div><div class="line"></div><div class="line"># ok</div></div><!-- fragment --><h2>Related</h2>
<ul>
