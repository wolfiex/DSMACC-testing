...
<title>DSMACC: assign-symbols [![NPM version](https://badge.fury.io/js/assign-symbols.svg)](http://badge.fury.io/js/assign-symbols)</title>
...
<div class="title">assign-symbols [![NPM version](<a href="https://badge.fury.io/js/assign-symbols.svg">https://badge.fury.io/js/assign-symbols.svg</a>)](<a href="http://badge.fury.io/js/assign-symbols">http://badge.fury.io/js/assign-symbols</a>) </div>  </div>
</div><!--header-->
<div class="contents">
...
<div class="fragment"><div class="line">$ npm i assign-symbols --save</div></div><!-- fragment --><h2>Usage</h2>
<div class="fragment"><div class="line">var assignSymbols = require(&#39;assign-symbols&#39;);</div><div class="line">var obj = {};</div><div class="line"></div><div class="line">var one = {};</div><div class="line">var symbolOne = Symbol(&#39;aaa&#39;);</div><div class="line">one[symbolOne] = &#39;bbb&#39;;</div><div class="line"></div><div class="line">var two = {};</div><div class="line">var symbolTwo = Symbol(&#39;ccc&#39;);</div><div class="line">two[symbolTwo] = &#39;ddd&#39;;</div><div class="line"></div><div class="line">assignSymbols(obj, one, two);</div><div class="line"></div><div class="line">console.log(obj[symbolOne]);</div><div class="line">//=&gt; &#39;bbb&#39;</div><div class="line">console.log(obj[symbolTwo]);</div><div class="line">//=&gt; &#39;ddd&#39;</div></div><!-- fragment --><h2>Similar projects</h2>
<ul>
...
<li><a href="https://www.npmjs.com/package/clone-deep">clone-deep</a>: Recursively (deep) clone JavaScript native types, like Object, Array, RegExp, <a class="el" href="classDate.html">Date</a> as well as primitives. | <a href="https://github.com/jonschlinkert/clone-deep">homepage</a></li>
