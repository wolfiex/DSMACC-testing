...
# all anth ['C2H6','C3H8','IC4H10','NC4H10','CHEX','IC5H12','M2PE','NC5H12','NC6H14','NC7H16','NC8H18','NC9H20','NC10H22','NC11H24','NC12H26','BENZENE','TOLUENE','EBENZ','OXYL','MXYL','IPBENZ','PBENZ','METHTOL','PETHTOL','TM135B','OETHTOL','TM124B','TM123B','DIME35EB','C2H4','C3H6','C2H2','TBUT2ENE','BUT1ENE','MEPROPENE','CBUT2ENE','C4H6','TPENT2ENE','CPENT2ENE']
NOX = ['NOEMISS','NO2EMIS','HONOSRC']
CO = ['CO']
LAROM = []
...
for i in names:
    if i in ['NOX','nox','NOx']:
        ...
        ratestring += "\n C(ind_%s)= 0.1*CFACTOR*10**seval(27,dfract,spcf(obs,:),spcf(%d,:),spcf(%d,:),spcf(%d,:),spcf(%d,:))"%(i,n(c),n(c),n(c),n(c))
        ratestring += '\n CONSTRAIN(ind_%s) = C(ind_%s)\n'%(i,i)
